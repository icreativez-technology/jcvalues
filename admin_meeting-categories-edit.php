                    ...
                    <div>
                        ...
                        <div>
                            <p><a href="/">Home</a> » <a class="cursor-pointer" data-bs-toggle="modal"
                                    ...
                                    data-bs-toggle="modal" data-bs-target="#admin-menu-modal">Meeting Basic Settings</a>
                                » <a href="/admin_meeting-categories.php">Meeting Categories Management</a> »
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    ...
                    <div class="container-custom" id="kt_content_container">
                        ...
                        <div class="card card-custom gutter-b example example-compact">
                            ...
                            <!--begin::Form-->
                            <form class="form" action="includes/basicsettings_meeting-categories_update.php"
                                method="post" enctype="multipart/form-data">
                                <input type="hidden" name="pg_id" id="pg_id"
                                    value="<?php echo $result_data['Id_meeting_category']; ?>" readonly>
                                <div class="card-body">
                                ...
                                <div class="p-4">
                                    <div class="row">
                                        <div style="text-align: right;"><input type="submit"
                                                ...
                                                href="/admin_meeting-categories.php"
