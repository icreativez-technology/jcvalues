...
$_SESSION['Page_Title'] = "View Interested Party - " . $resultData['year'];
?>
<!DOCTYPE html>
<html lang="en">
                        ...
                        <div class="card card-flush">
                                ...
                                <div class="row">
                                    <div class="col-md-12 mt-3">
                                        <table class="table table-row-dashed fs-6 gy-5">
                                            ...
                                            <tbody class="text-gray-600 fw-bold" id="interested-party-table">
                                                <?php if ($parties && count($parties) > 0) {
                                                    foreach ($parties as $key => $party) { ?>
                                                <tr>
                                                    <td><input type="text" class="form-control"
                                                            value="<?php echo $party['interested_party']; ?>" disabled>
                                                    </td>
                                                    <td><input type="text" class="form-control"
                                                            value="<?php echo $party['requirements']; ?>" disabled></td>
                                                    <td><input type="text" class="form-control"
                                                            value="<?php echo $party['expectations']; ?>" disabled></td>
                                                    <td><input type="text" class="form-control"
                                                            value="<?php echo $party['type']; ?>" disabled></td>
                                                </tr>
                                                <?php }
                                                } ?>
                                            </tbody>
                            ...
                            <div class="card-footer">
                                <div class="row" style="text-align:center; float:right;">
                                    <div class="mb-4">
                                        <a type="button" href="/interested-parties.php"
