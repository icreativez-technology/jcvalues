							  ...
							  <div class="form-group row">
							   <div class="col-lg-6">
							    <label>Description</label>
									<p><?php echo $result_datos_capa['Description']; ?></p>
									
							   </div>
							   <div class="col-lg-6">
							    <label>Date</label>
									<p><?php echo date("d-m-y", strtotime($result_datos_capa['Date_capa']));  ?></p>
							   </div>
							  </div>
							  ...
							  <div class="form-group row">
							   <div class="col-lg-6">
							     <label>Action by </label>
										...
										<?php
											$Action_by_Auditee = $result_datos_capa['Action_by_Auditee'];
											$consulta_employee ="SELECT * FROM Basic_Employee WHERE Id_employee = $Action_by_Auditee";
											$consulta_result_employee = mysqli_query($con, $consulta_employee);
											$result_general_employee = mysqli_fetch_assoc($consulta_result_employee)
										?>
										<p><?php echo $result_general_employee['First_Name'].' '.$result_general_employee['Last_Name']; ?></p>
							   ...
							   <div class="col-lg-6">
							    <label>Issued by </label>
									...
									<?php 
										$Issued_by_Auditor = $result_datos_capa['Issued_by_Auditor'];
										$consulta_employee ="SELECT * FROM Basic_Employee WHERE Id_employee = $Issued_by_Auditor";
										$consulta_result_employee = mysqli_query($con, $consulta_employee);
										$result_general_employee = mysqli_fetch_assoc($consulta_result_employee)
							  ...
							  <div class="form-group row">
							   <div class="col-lg-6">
							    <label>Finding Type</label>
									...
									<?php
										$result_datos_capa = $result_datos_capa['Id_finding_types'];
										$consulta_ftype ="SELECT * FROM Finding_Types WHERE Id_finding_types = $result_datos_capa";
										$consulta_result_ftype = mysqli_query($con, $consulta_ftype);
										$result_general_ftype = mysqli_fetch_assoc($consulta_result_ftype)
									?>
									<p><?php echo $result_general_ftype['Title']; ?></p>
