...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  $title = $_POST["title"];
  $isExists = "SELECT id FROM mt_media_type WHERE title = '$title'";
  ...
  if ($result->num_rows == 0) {
    if ($_SESSION['usuario']) {
      ...
      $sqlAdd = "INSERT INTO mt_media_type(title, created_by) VALUES ('$title', '$userId')";
    ...
    header("Location: ../mt-media-type.php?exist");
  }
} else {
