...
$getSql = "SELECT * FROM customer_complaint_d4_why_analysis WHERE id = '$requestId' ";
...
$deleteQuery = "UPDATE customer_complaint_d4_why_analysis SET is_deleted = 1 WHERE id = '$requestId'";
