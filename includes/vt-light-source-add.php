...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  $title = $_POST["title"];
  $isExists = "SELECT id FROM vt_light_source WHERE title = '$title'";
  ...
  if ($result->num_rows == 0) {
    if ($_SESSION['usuario']) {
      ...
      $sqlAdd = "INSERT INTO vt_light_source (title, created_by) VALUES ('$title', '$userId')";
    ...
    header("Location: ../vt-light-source.php?exist");
  }
} else {
