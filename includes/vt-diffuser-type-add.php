...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  $title = $_POST["title"];
  $isExists = "SELECT id FROM vt_diffuser_type WHERE title = '$title'";
  ...
  if ($result->num_rows == 0) {
    if ($_SESSION['usuario']) {
      ...
      $sqlAdd = "INSERT INTO vt_diffuser_type (title, created_by) VALUES ('$title', '$userId')";
    ...
    header("Location: ../vt-diffuser-type.php?exist");
  }
} else {
