...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  $title = $_POST["title"];
  $isExists = "SELECT id FROM pt_penetrant_type WHERE title = '$title'";
  ...
  if ($result->num_rows == 0) {
    if ($_SESSION['usuario']) {
      ...
      $sqlAdd = "INSERT INTO pt_penetrant_type(title, created_by) VALUES ('$title', '$userId')";
    ...
    header("Location: ../pt-penetrant-type.php?exist");
  }
} else {
