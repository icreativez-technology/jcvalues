...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	$title = $_POST["title"];
	$isExists = "SELECT id FROM screen_heights WHERE title = '$title'";
	...
	if ($result->num_rows == 0) {
		if ($_SESSION['usuario']) {
			...
			$sqlAdd = "INSERT INTO screen_heights (title, created_by) VALUES ('$title', '$userId')";
		...
		header("Location: ../screen-height.php?exist");
	}
} else {
