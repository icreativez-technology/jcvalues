				...
				while ($result_data = mysqli_fetch_assoc($consultaBD)) {
					...
					if($iscoord==0){
								...
								';
									...
									echo '<td class="text-end"><a href="/admin_meeting-coordinators-delete.php?pg_id='.$result_data2['Id_meeting_co_ordinator'].'" class="menu-link px-3"><i class="bi bi-trash" style="padding-right: 4px;"></i></a></td>';
