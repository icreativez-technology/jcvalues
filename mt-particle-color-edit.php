...
$_SESSION['Page_Title'] = "Edit Particle Color";
$sqlData = "SELECT title FROM mt_particle_color WHERE id LIKE '$_REQUEST[id]'";
                        ...
                        <div>
                            <p>
                                ...
                                <a class="cursor-pointer" data-bs-toggle="modal" data-bs-target="#admin-menu-modal">
                                    Magnetic Test</a> »
                                <a href="/mt-particle-color.php">Particle Color</a> »
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    <div class="container-custom" id="kt_content_container">
                        <div class="card card-custom gutter-b example example-compact">
                            ...
                            <form action="includes/mt-particle-color-update.php" method="post"
