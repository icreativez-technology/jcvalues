...
$_SESSION['Page_Title'] = "View Q-Alert - " . $qAlert['q_alert_id'];
?>
<!DOCTYPE html>
<html lang="en">
									...
									<form class="form" action="includes/q_alert_update.php" method="post" enctype="multipart/form-data">
											...
											<div id="custom-section-1">
												<div class="form-group row">
													<div class="col-lg-3 mt-5">
														...
														?>
														<input type="text" class="form-control" name="on_behalf_of" required value="<?php echo $result_data['First_Name'] . ' ' . $result_data['Last_Name']; ?>" disabled />
													</div>
													<div class="col-lg-3 mt-5">
														...
														$result_data = mysqli_fetch_assoc($connect_data);
														?>
														<input type="text" class="form-control" name="plant_id" required value="<?php echo $result_data['Title']; ?>" disabled />
													</div>
													<div class="col-lg-3 mt-5">
														...
														$result_data = mysqli_fetch_assoc($connect_data);
														?>
														<input type="text" class="form-control" name="product_group_id" required value="<?php echo $result_data['Title']; ?>" disabled />
													</div>
													<div class="col-lg-3 mt-5">
														...
														$result_data = mysqli_fetch_assoc($connect_data);
														?>
														<input type="text" class="form-control" name="department_id" required value="<?php echo $result_data['Department']; ?>" disabled />
													</div>
												</div>
												<div class="form-group row">
													<div class="col-lg-3 mt-5">
														...
														$result_data = mysqli_fetch_assoc($connect_data);
														?>
														<input type="text" class="form-control" name="area_process_id" required value="<?php echo $result_data['title']; ?>" disabled />
													</div>
													<div class="col-lg-3 mt-5">
														...
														$result_data = mysqli_fetch_assoc($connect_data);
														?>
														<input type="text" class="form-control" name="nature_of_obs_id" required value="<?php echo $result_data['title']; ?>" disabled />
													</div>
													<div class="col-lg-3 mt-5">
														<label class="required">Date</label>
														<input type="date" class="form-control" name="date" required value="<?php echo $qAlert['date']; ?>" disabled />
													</div>
													<div class="col-lg-3 mt-5">
														<label>Shift</label>
														<input type="text" class="form-control" name="shift" value="<?php echo $qAlert['shift']; ?>" disabled>
													</div>
												</div>
												<div class="form-group row">
													<div class="col-lg-12 mt-5">
														<label class="required">Observation Details</label>
														<textarea type="text" rows="3" class="form-control" name="obs_details" required disabled><?php echo $qAlert['obs_details']; ?></textarea>
													</div>
												</div>
												<div class="form-group row mt-5">
													...
													<?php } else { ?>
														<div class="col-lg-12 mt-2">
															<input type="text" class="form-control" name="files" value="No uploaded files available" disabled>
														</div>
													<?php } ?>
												</div>
												<div class="form-group row">
													<div class="col-lg-4 mt-5">
														...
														$result_data = mysqli_fetch_assoc($connect_data);
														?>
														<input type="text" class="form-control" name="action_category_id" required value="<?php echo $result_data['title']; ?>" disabled />
													</div>
													<div class="col-lg-8 mt-5">
														<label class="required">Detail of Solution</label>
														<input type="text" class="form-control" name="detail_of_solution" required value="<?php echo $qAlert['detail_of_solution']; ?>" disabled>
													</div>
												</div>
											</div>
										</div>
										<div class="card-footer">
											<div class="row" style="text-align:center; float:right;">
												<div class="mb-4">
													<a type="button" href="/q_alert_view_list.php" class="btn btn-sm btn-secondary ms-2">Close</a>
												</div>
											</div>
										</div>
									...
									<form class="form" action="includes/q_alert_q_head_review_update.php" method="post" enctype="multipart/form-data">
										<div class="card-body">
											<div class="form-group row">
												...
												<div class="col-lg-8 mt-5">
													<label class="required">Detail of Solution</label>
													<input class="form-control" name="detail_of_solution" required value="<?php echo $headReview['detail_of_solution']; ?>" disabled />
												</div>
											</div>
											<div class="form-group row">
												<div class="col-lg-4 mt-5">
												...
												<div class="col-lg-8 mt-5">
													...
													$result_data = mysqli_fetch_assoc($connect_data);
													?>
													<input type="text" class="form-control" name="owner" required value="<?php echo $result_data['First_Name'] . ' ' . $result_data['Last_Name']; ?>" disabled />
												</div>
											</div>
										</div>
										<div class="card-footer">
									...
									<form class="form" action="includes/q_alert_hod_review_update.php" method="post" enctype="multipart/form-data">
										<div class="card-body">
											<div class="form-group row">
												...
												<div class="col-lg-8 mt-5">
													<label class="required">Detail of Solution</label>
													<input class="form-control" name="detail_of_solution" required value="<?php echo $hodReview['detail_of_solution']; ?>" disabled />
												</div>
											</div>
											<div class="form-group row">
												<div class="col-lg-4 mt-5">
												...
												<?php if ($correctiveAction && count($correctiveAction) > 0) {
													foreach ($correctiveAction as $key => $item) { ?>
														<tr>
															...
															<?php
															$sql_data = "SELECT * FROM Basic_Employee WHERE Id_employee = $item[who] AND Status = 'Active'";
															$connect_data = mysqli_query($con, $sql_data);
															$who = mysqli_fetch_assoc($connect_data);
															?>
															<input type="hidden" class="form-control" name="ca_who" value="<?php echo $who['First_Name'] . ' ' . $who['Last_Name']; ?>">
															...
															<td>
																<button type="button" class="btn btn-link me-3" onclick="openViewPopup(this);">
				...
				<div class="modal-body" style="overflow-y:scroll">
					<div class="row">
						<div class="col-md-12">
							...
							<textarea class="form-control" name="root_cause" id="root_cause" disabled></textarea>
						</div>
					</div>
					<div class="row mt-4">
						<div class="col-md-12">
							<label class="required">Corrective Action</label>
							<textarea class="form-control" name="corrective_action" id="corrective_action" disabled></textarea>
						</div>
					</div>
					<div class="row mt-4">
						<div class="col-md-12">
							<label class="required">Who</label>
							<input type="text" class="form-control" name="who" id="who" disabled />
						</div>
					</div>
					<div class="row mt-4">
						<div class="col-md-12">
					...
					<div class="row mt-4">
						<div class="col-md-12">
							...
							<textarea class="form-control" name="how" id="how" disabled></textarea>
						</div>
					</div>
					<div class="row mt-4">
						<div class="col-md-3">
							<div class="form-check">
								<input class="form-check-input" type="checkbox" id="moc" name="moc" disabled>
						...
						<div class="col-md-9">
							<div class="form-check">
								<input class="form-check-input" type="checkbox" id="risk_assessment" name="risk_assessment" disabled>
