...
$_SESSION['Page_Title'] = "Edit Viewing Method";
$sqlData = "SELECT title FROM vt_viewing_method WHERE id LIKE '$_REQUEST[id]'";
                    ...
                    <div>
                        <div>
                            <p>
                                ...
                                <a href="/vt-viewing-method.php">Viewing Method</a> »
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    <div class="container-custom" id="kt_content_container">
                        <div class="card card-custom gutter-b example example-compact">
                            ...
                            <form action="includes/vt-viewing-method-update.php" method="post"
