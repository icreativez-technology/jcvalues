...
$sql = "SELECT * FROM  audit_area WHERE Id_audit_area = '$_REQUEST[id]'";
                    ...
                    <div>
                        ...
                        <div>
                            <p><a href="/">Home</a> » <a href="/admin-panel.php">Admin Panel</a> » <a
                                    ...
                                    href="/admin_audit-area.php">Audit Area</a> »
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    ...
                    <div class="container-custom" id="kt_content_container">
                        ...
                        <div class="card card-custom gutter-b example example-compact">
                            ...
                            <!--begin::Form-->
                            <form class="form" action="includes/basicsettings_audit-area_edit.php" method="post"
                                enctype="multipart/form-data">
                                <div class="card-body">
                                    <div class="form-group row">
                                        <input type="hidden" name="id"
                                            value="<?php echo $result_var['Id_audit_area'] ?>">
                                        <div class="col-md-6">
