...
$_SESSION['Page_Title'] = "Usage Condition";
...
<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed aside-fixed aside-secondary-disabled">
				...
				<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
					...
					<div class="container-custom" id="kt_content_container">
						...
						<div class="card">
							...
							<form action="includes/usage-condition-add.php" method="post" enctype="multipart/form-data">
							...
							<div class="card-body pt-0 table-responsive">
								...
								<table class="table align-middle table-row-dashed fs-6 gy-5 gx-5" id="kt_department_table">
									...
									<tbody class="fw-bold text-gray-600">
										<?php
										$sql_data = "SELECT * FROM usage_condition WHERE is_deleted = 0 order by id DESC";
										...
										?>
											<tr>
												...
												<?php if ($result_data['status'] == "1") { ?>
													<td>
														<a href="/includes/usage-condition-status.php?id=<?php echo $result_data['id']; ?>">
												...
												<?php } ?>
												<td class="text-end">
													<a href="/usage-condition-edit.php?id=<?php echo $result_data['id']; ?>" class="me-2"><i class="bi bi-pencil"></i></a>
													<?php if (true) { ?>
														<a href="/includes/usage-condition-delete.php?id=<?php echo $result_data['id']; ?>"><i class="bi bi-trash"></i></a>
													<?php } ?>
												</td>
											</tr>
										<?php
								...
								<ul class="pagination pagination-circle pagination-outline">
									...
									?>
											...
											?>
												<li class="page-item m-1 active"><a href="/usage-condition.php?page=<?php echo $actual_page; ?>" class="page-link"><?php echo $actual_page; ?></a></li>
											<?php } else { ?>
												<li class="page-item m-1"><a href="/usage-condition.php?page=<?php echo $actual_page; ?>" class="page-link"><?php echo $actual_page; ?></a></li>
											<?php } ?>
									<?php
										}
									} ?>
	...
	<script src="JS/buscar-usage-condition.js"></script>
