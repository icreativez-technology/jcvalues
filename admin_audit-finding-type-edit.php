...
$_SESSION['Page_Title'] = "Edit Finding type";
$sql = "SELECT * FROM  finding_types WHERE Id_finding_types = '$_REQUEST[id]'";
                    ...
                    <div>
                        ...
                        <div>
                            <p><a href="/">Home</a> » <a class="cursor-pointer" data-bs-toggle="modal"
                                    ...
                                    href="/admin_audit-finding-type.php">Finding Type</a> »
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    ...
                    <div class="container-custom" id="kt_content_container">
                        ...
                        <div class="card card-custom gutter-b example example-compact">
                            ...
                            <!--begin::Form-->
                            <form class="form" action="includes/basicsettings_audit-finding-type_edit.php" method="post"
                                enctype="multipart/form-data">
                                <div class="card-body">
                                    <div class="form-group row">
                                        <input type="hidden" name="id"
                                            value="<?php echo $result_var['Id_finding_types'] ?>">
                                        <div class="col-md-6">
                                            <label>Title</label>
                                            <input type="text" class="form-control" name="title"
                                                value="<?php echo $result_var['Title'] ?>" required>
                                ...
                                <div class="p-4">
                                    <div class="row">
                                        <div style="text-align: right;"><input type="submit"
                                                ...
                                                href="/admin_audit-finding-type.php"
