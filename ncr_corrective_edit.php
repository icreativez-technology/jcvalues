...
$_SESSION['Page_Title'] = "Edit Corrective Action Plan";

 $sql_data = "SELECT * FROM NCR_Corrective_Action_Plan WHERE Id_ncr_corrective = '$_REQUEST[pg_id]'";
					...
					<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
						...
						<div class="container-custom" id="kt_content_container">
                         ...
                         <!-- AQUI AÑADIR EL CONTENIDO  -->
                         	...
                         	<form class="form" action="includes/ncr_corrective_update_individual.php" method="post" enctype="multipart/form-data">
                         		<input type="hidden" name="pg_id" id="pg_id" value="<?php echo $result_data['Id_ncr_corrective']; ?>" readonly>
							 ...
							 <div class="card-body">
									 <div id="custom-section-1">
									  ...
									  <div class="form-group row">
									   ...
									   <div class="col-lg-4">
									    <label>#Review</label>
											<input type="text" class="form-control" name="Review" value="<?php echo $result_data['Review'];?>" required>
									   </div>

									   <div class="col-lg-4">
									    <label>Status</label>
											<input type="number" class="form-control" name="Status" value="<?php echo $result_data['Status'];?>" min='0' max='100' required>
									   </div>
