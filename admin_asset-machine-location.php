...
$_SESSION['Page_Title'] = "Machine Location Management";
...
<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed aside-fixed aside-secondary-disabled">
		...
		<div class="page d-flex flex-row flex-column-fluid">
			...
			<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
				...
				<div class="row breadcrumbs">
					<div class="col-lg-6">
						<p><a href="/">Home</a> » <a href="/admin-panel.php">Admin Panel</a> » <a href="/admin_asset-panel.php">Asset Basic Settings</a> »
				...
				<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
					...
					<div class="container-custom" id="kt_content_container">
						...
						<div class="card">
							...
							<!--Add form-->
							<form action="includes/basicsettings_asset-machine-location_add.php" method="post" enctype="multipart/form-data">
									...
									<div class="col-md-5">
										<div class="form-group">
											...
											<?php if (isset($_GET['exist'])) { ?>
												<small class="text-danger">The machine location name has already been taken</small>
											<?php } ?>
										</div>
									</div>
									<div class="col-md-2">
							...
							<div class="pt-6 ms-5 mb-5">
								...
								<div class="row">
									...
									<div class="col-md-6 d-flex align-items-center position-relative my-1">
										...
										<!--end::Svg Icon-->
										<input type="text" data-kt-filemanager-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Search Machine Location" id="termino" name="termino" />
									</div>
									<!--end::Search-->
								</div>
								<!--begin::Card title-->
							...
							<div class="card-body pt-0 table-responsive">
								...
								<table class="table align-middle table-row-dashed fs-6 gy-5 gx-5">
									...
									<tbody class="fw-bold text-gray-600">
										<?php
										$sql_data = "SELECT * FROM Asset_Machine_Location";
										...
										?>
											<tr>
												...
												<?php if ($result_data['Status'] == 'Active') { ?>
													<td><a href="/includes/basicsettings_asset-machine-location_status?pg_id=<?php echo $result_data['Id_asset_machine_location']; ?>">
												...
												<!--begin::Action=-->
												<td class="text-end">
													<a href="/admin_asset-machine-location-edit.php?pg_id=<?php echo $result_data['Id_asset_machine_location']; ?>"><i class="bi bi-pencil" style="padding-right: 4px;"></i></a>
													<?php if ($role == 1) { ?>
														<a href="/admin_asset-machine-location-delete.php?pg_id=<?php echo $result_data['Id_asset_machine_location']; ?>"><i class="bi bi-trash" style="padding-right: 4px;"></i></a>
													<?php } ?>
												</td>
												<!--end::Action=-->
											</tr>
	...
	<!-- BUSCADOR SEARCH PARA: Machine Location -->
	<script src="JS/buscar-asset-machine-location.js"></script>
	...
	<script>
		...
		function createPagination(totalPages, page) {
			...
			let lastPage = ">>";
			liTag +=
				`<li class="page-item m-1"><a href="/admin_asset-machine-location.php?page=${1}" class="page-link">${firstPage}</a></li>`;
			if (page > 1) {
				liTag +=
					`<li class="page-item m-1"><a href="/admin_asset-machine-location.php?page=${page - 1}" class="page-link">${prevLabel}</a></li>`;
			}
			if (page == totalPages) {
			...
			for (var plength = beforePage; plength <= afterPage; plength++) {
				...
				liTag +=
					`<li class="page-item m-1 ${active}"><a href="/admin_asset-machine-location.php?page=${plength}" class="page-link">${plength}</a></li>`;
			}
			if (page < totalPages) {
				liTag +=
					`<li class="page-item m-1"><a href="/admin_asset-machine-location.php?page=${page + 1}" class="page-link">${nextLabel}</a></li>`;
			}
			liTag +=
				`<li class="page-item m-1"><a href="/admin_asset-machine-location.php?page=${totalPages}" class="page-link">${lastPage}</a></li>`;
