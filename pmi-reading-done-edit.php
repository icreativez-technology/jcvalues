...
$_SESSION['Page_Title'] = "Edit Reading Done On";
$sqlData = "SELECT title FROM pmi_reading_done WHERE id LIKE '$_REQUEST[id]'";
                    ...
                    <div>
                        <div>
                            <p>
                                ...
                                <a href="/pmi-reading-done.php">Reading Done On</a> »
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    <div class="container-custom" id="kt_content_container">
                        <div class="card card-custom gutter-b example example-compact">
                            ...
                            <form action="includes/pmi-reading-done-update.php" method="post"
