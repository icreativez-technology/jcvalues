...
$_SESSION['Page_Title'] = "Edit Magnetization Technique";
$sqlData = "SELECT title FROM mt_magnetization_technique WHERE id LIKE '$_REQUEST[id]'";
                    ...
                    <div>
                        <div>
                            <p>
                                ...
                                <a href="/mt-magnetization-technique.php">Magnetization Technique</a> »
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    <div class="container-custom" id="kt_content_container">
                        <div class="card card-custom gutter-b example example-compact">
                            ...
                            <form action="includes/mt-magnetization-technique-update.php" method="post"
