                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    ...
                    <div class="container-custom" id="kt_content_container">
                        ...
                        <div class="card card-custom gutter-b example example-compact">
                            ...
                            <!--begin::Form-->
                            <form class="form" action="includes/basicsettings_plants_add.php" method="post"
                                    ...
                                    <div class="form-group row mt-3">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <select class="form-control form-select-solid select2-hidden-accessible"
                                                ...
                                                <option></option>
                                                <?php
                                                $sql_data_Product_Group = "SELECT * FROM Basic_Product_Group WHERE Status LIKE 'Active'";
                                                ...
                                                ?>
                                                <option
                                                    value="<?php echo $result_data_Product_Group['Id_product_group']; ?>">
                                                    <?php echo $result_data_Product_Group['Title']; ?></option>
                                                <?php
                                                }
                                                ?>
                                            </select>
