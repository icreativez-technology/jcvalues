				...
				while ($result_data = mysqli_fetch_assoc($consultaBD)) {
					...
					if($iscoord==0){
								...
								';
									...
									echo '<td class="text-end"><a href="/admin_cm-coordinators-delete.php?pg_id='.$result_data2['Id_customer_inspection_co_ordinator'].'"><i class="bi bi-trash" style="padding-right: 4px;"></i></a></td>';
