...
$_SESSION['Page_Title'] = "Calibration Frequency";
...
<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed aside-fixed aside-secondary-disabled">
		...
		<div class="page d-flex flex-row flex-column-fluid">
			...
			<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
				...
				<div class="row breadcrumbs">
					<div class="col-lg-6">
						<p><a href="/">Home</a> » <a href="/admin-panel.php">Admin Panel</a> » <a href="/calibrations.php">Calibrations</a> » <?php echo $_SESSION['Page_Title']; ?></p>
					</div>
				</div>
				...
				<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
					...
					<div class="container-custom" id="kt_content_container">
						...
						<div class="card">
							...
							<form action="includes/calibration-frequency-add.php" method="post" enctype="multipart/form-data">
									...
									<div class="col-md-5">
										<div class="form-group">
											...
											<?php if (isset($_GET['exist'])) { ?>
												<small class="text-danger">The calibration frequency name has already been taken</small>
											<?php } ?>
										</div>
									</div>
									<div class="col-md-2">
							...
							<div class="row mt-2 mb-4 ms-2">
								<div class="col-md-3">
									...
									<div class="d-flex align-items-center position-relative my-1">
										...
										<!--end::Svg Icon-->
										<input type="text" data-kt-filemanager-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Search Calibration Frequency" id="termino" name="termino" />
									</div>
									<!--end::Search-->
								</div>
							</div>
							...
							<div class="card-body pt-0 table-responsive">
								...
								<table class="table align-middle table-row-dashed fs-6 gy-5 gx-5" id="kt_department_table">
									...
									<tbody class="fw-bold text-gray-600">
										<?php
										$sql_data = "SELECT * FROM calibration_frequency WHERE is_deleted = 0 order by id DESC";
										...
										?>
											<tr>
												...
												<?php if ($result_data['status'] == "1") { ?>
													<td>
														<a href="/includes/calibration-frequency-status.php?id=<?php echo $result_data['id']; ?>">
												...
												<?php } ?>
												<td class="text-end">
													<a href="/calibration-frequency-edit.php?id=<?php echo $result_data['id']; ?>" class="me-2"><i class="bi bi-pencil"></i></a>
													<?php if (true) { ?>
														<a href="/includes/calibration-frequency-delete.php?id=<?php echo $result_data['id']; ?>"><i class="bi bi-trash"></i></a>
													<?php } ?>
												</td>
											</tr>
										<?php
								...
								<ul class="pagination pagination-circle pagination-outline">
									...
									?>
											...
											?>
												<li class="page-item m-1 active"><a href="/calibration-frequency.php?page=<?php echo $actual_page; ?>" class="page-link"><?php echo $actual_page; ?></a></li>
											<?php } else { ?>
												<li class="page-item m-1"><a href="/calibration-frequency.php?page=<?php echo $actual_page; ?>" class="page-link"><?php echo $actual_page; ?></a></li>
											<?php } ?>
									<?php
										}
									} ?>
	...
	<script src="JS/buscar-calibration-frequency.js"></script>
