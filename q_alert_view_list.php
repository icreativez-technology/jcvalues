...
$_SESSION['Page_Title'] = "Q-Alert List";
...
$columns = array('id', 'q_alert_id', 'plant', 'created_by', 'created_at', 'product_group', 'department', 'owner', 'status');
...
<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed aside-fixed aside-secondary-disabled">
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                ...
                <div class="row breadcrumbs">
                    <div class="col-lg-6 col-sm-12">
                        <p><a href="/">Home</a> » <a href="/q_alert.php">Q-Alert</a> »
                        ...
                        <div class="card mt-4">
                                ...
                                <div class="col-3">
                                 ...
                                 <!--    <div class="d-flex align-items-center position-relative my-1">
                                        ...
                                        <input type="text" data-kt-filemanager-table-filter="search"
                                            ...
                                            placeholder="Search Q-Alert" id="termino" name="termino" />
                                    </div> -->
                                    <!--end::Search-->
                                </div>
                                <div class="col-9">
                                    <div class="d-flex justify-content-end">
                                        ...
                                        <button id="btnExport" onclick="fnExcelReport('qAlert.xlsx');"
                            ...
                            <div class="card-body pt-0 table-responsive">
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5 gx-5"
                                    id="kt_department_table" data-cols-width="20,20,20, 20, 20, 20, 20, 10">
                                    <!--begin::Table head-->
                                    <thead>
                                        <!--begin::Table row-->
                                        <tr class="text-start text-gray-400 text-uppercase gs-0" data-height="30">
                                            <th class="min-w-125px">
                                                <!-- <a
                                                    href="/q_alert_view_list.php?a=qAlert&column=q_alert_id&order=<?php echo $asc_or_desc; ?>&sorting_status=true">
                                                    Unique ID<i
                                                        class="fas fa-sort<?php echo $column == 'q_alert_id' ? '-' . $up_or_down : ''; ?>"></i>
                                                </a> -->
                                                Unique ID
                                            ...
                                            <th class="min-w-150px">
                                                <!-- <a
                                                    href="/q_alert_view_list.php?a=qAlert&column=plant&order=<?php echo $asc_or_desc; ?>&sorting_status=true">
                                                    Plant<i
                                            ...
                                            <th class="min-w-150px">
                                               <!--  <a
                                                    href="/q_alert_view_list.php?a=qAlert&column=created_by&order=<?php echo $asc_or_desc; ?>&sorting_status=true">
                                                    Created By<i
                                            ...
                                            <th class="min-w-150px">
                                               <!--  <a
                                                    href="/q_alert_view_list.php?a=qAlert&column=created_at&order=<?php echo $asc_or_desc; ?>&sorting_status=true">
                                                    Created At<i
                                            ...
                                            <th class="min-w-150px">
                                              <!--   <a
                                                    href="/q_alert_view_list.php?a=qAlert&column=product_group&order=<?php echo $asc_or_desc; ?>&sorting_status=true">
                                                    Product Group<i
                                            ...
                                            <th class="min-w-150px">
                                                <!-- <a
                                                    href="/q_alert_view_list.php?a=qAlert&column=department&order=<?php echo $asc_or_desc; ?>&sorting_status=true">
                                                    Department<i
                                            ...
                                            <th class="min-w-150px">
                                              <!--   <a
                                                    href="/q_alert_view_list.php?a=qAlert&column=owner&order=<?php echo $asc_or_desc; ?>&sorting_status=true">
                                                    Owner<i
                                                        class="fas fa-sort<?php echo $column == 'owner' ? '-' . $up_or_down : ''; ?>"></i>
                                                </a> -->
                                                Owner
                                            </th>
                                            <th class="min-w-100px">
                                               <!--  <a
                                                    href="/q_alert_view_list.php?a=qAlert&column=status&order=<?php echo $asc_or_desc; ?>&sorting_status=true">
                                                    Status<i
                                    ...
                                    <tbody class="fw-bold text-gray-600">
                                        <?php
                                        $sql_data = "SELECT q_alert.*, Basic_Employee.First_Name, Basic_Employee.Last_Name, Basic_Department.Department, Basic_Plant.Title as plant, Basic_Product_Group.Title as product_group FROM q_alert LEFT JOIN Basic_Employee ON q_alert.created_by = Basic_Employee.Id_employee
										...
										WHERE q_alert.is_deleted = 0 AND q_alert.q_alert_id LIKE '%$uniqID%' AND q_alert.created_at LIKE '%$createDt%'  order by " . $columnsQueryItem[$column] . " " . $sort_order;
                                        ...
                                        <tr>
                                            <td>
                                                <?php echo $result_data['q_alert_id']; ?>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <?php if ($canView == 1) { ?>
                                                <a href="q_alert_view.php?id=<?php echo $result_data['id']; ?>"
                                                    class="me-3"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                                <?php } ?>
                                                <?php if ($result_data['status'] == "Closed") { ?>
                                                <?php if ($canView == 1) { ?>
                                                <a data-id='<?php echo $result_data['id']; ?>'
                                                    data-unique='<?php echo $result_data['q_alert_id']; ?>'
                                                    target="_blank" class="print-q-alert me-3"><i
                                                        class="bi bi-file-earmark-pdf" aria-hidden="true"></i></a>
                                                <?php } ?>
                                                <?php } else { ?>
                                                <?php if ($canEdit == 1) { ?>
                                                <a href="q_alert_edit.php?id=<?php echo $result_data['id']; ?>"
                                                    class="me-3 set-url"><i class="bi bi-pencil"
                                                        aria-hidden="true"></i></a>
                                                <?php } ?>
                                                <?php } ?>
                                                <?php if ($role == 1 || $canDelete == 1) { ?>
                                                <a href="/includes/q_alert_delete.php?id=<?php echo $result_data['id']; ?>"
    ...
    <script src="JS/buscar-q-alert-view-list.js"></script>
    ...
    <!--end::Page Custom Javascript-->
     <script>
        ...
        function resetFilter() {
            window.location.href = base_url + '/q_alert_view_list.php?a=9';
        }
    ...
    function createPagination(totalPages, page) {
        ...
        let lastPage = ">>";
        liTag +=
            `<li class="page-item m-1"><a href="/q_alert_view_list.php?a=qAlert&page=${1}&limit=${pageLimit}&column=<?php echo $column; ?>&order=${asc_or_desc}" class="page-link">${firstPage}</a></li>`;
        if (page > 1) {
            liTag +=
                `<li class="page-item m-1"><a href="/q_alert_view_list.php?a=qAlert&page=${page - 1}&limit=${pageLimit}&column=<?php echo $column; ?>&order=${asc_or_desc}" class="page-link">${prevLabel}</a></li>`;
        }
        if (page == totalPages) {
        ...
        for (var plength = beforePage; plength <= afterPage; plength++) {
            ...
            liTag +=
                `<li class="page-item m-1 ${active}"><a href="/q_alert_view_list.php?a=qAlert&page=${plength}&limit=${pageLimit}&column=<?php echo $column; ?>&order=${asc_or_desc}" class="page-link">${plength}</a></li>`;
        }
        if (page < totalPages) {
            liTag +=
                `<li class="page-item m-1"><a href="/q_alert_view_list.php?a=qAlert&page=${page + 1}&limit=${pageLimit}&column=<?php echo $column; ?>&order=${asc_or_desc}" class="page-link">${nextLabel}</a></li>`;
        }
        liTag +=
            `<li class="page-item m-1"><a href="/q_alert_view_list.php?a=qAlert&page=${totalPages}&limit=${pageLimit}&column=<?php echo $column; ?>&order=${asc_or_desc}" class="page-link">${lastPage}</a></li>`;
    ...
    $('.print-q-alert').on('click', function() {
        let id = $(this).data('id');
        let unique = $(this).data('unique');
        $.get(`/includes/q_alert_pdf.php?id=${id}`, function(data) {
            let opt = {
