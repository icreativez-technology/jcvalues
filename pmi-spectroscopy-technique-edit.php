...
$_SESSION['Page_Title'] = "Edit Spectroscopy Technique";
$sqlData = "SELECT title FROM pmi_spectroscopy_technique WHERE id LIKE '$_REQUEST[id]'";
                    ...
                    <div>
                        <div>
                            <p>
                                ...
                                <a class="cursor-pointer" data-bs-toggle="modal"
                                    data-bs-target="#admin-menu-modal">Positive Material Identification</a> »
                                <a href="/pmi-spectroscopy-technique.php">Spectroscopy Technique</a> »
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    <div class="container-custom" id="kt_content_container">
                        <div class="card card-custom gutter-b example example-compact">
                            ...
                            <form action="includes/pmi-spectroscopy-technique-update.php" method="post"
