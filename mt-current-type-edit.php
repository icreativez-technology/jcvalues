<?php
    ...
    $_SESSION['Page_Title'] = "Edit Current Type";
    $sqlData = "SELECT title FROM mt_current_type WHERE id LIKE '$_REQUEST[id]'";
                    ...
                    <div>
                        <div>
                            <p>
                                ...
                                <a href="/non-destructive-examination.php">Non-Destructive Examination</a> » 
                                <a href="/magnetic-test.php">Magnetic Test</a> » 
                                <a href="/mt-current-type.php">Current Type</a> » 
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    <div class="container-custom" id="kt_content_container">
                        <div class="card card-custom gutter-b example example-compact">
                            ...
                            <form action="includes/mt-current-type-update.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row mt-3 ms-6 mb-6">
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <small class="text-danger">The current type name has already been
                                                taken</small>
                                            <?php } ?>
                                        </div>
                                    </div>
                                    <div class="col-md-2 d-flex pt-6">
                                        ...
                                        <a href="/mt-current-type.php" class="btn btn-sm btn-danger mt-3 ms-2">Cancel</a>
                                    </div>
                                </div>
                            </form>
                        </div>
