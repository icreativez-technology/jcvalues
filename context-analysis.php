...
$_SESSION['Page_Title'] = "Internal and External Context Analysis";
...
$columns = array('id', 'year', 'revision', 'created_at', 'revision_date', 'created_by', 'approved_by');
...
<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed aside-fixed aside-secondary-disabled">
                ...
                <div class="row mt-2">
                    <div class="col-lg-12">
                        <ul class="nav nav-tabs custom-tab" id="myTab" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <a href="/context-analysis.php?a=1" class="header-bar nav-link active">
                            ...
                            <div class="row mb-4 ms-2">
                                <div class="col-3">
                                    ...
                                    <div class="d-flex align-items-center position-relative my-1">
                                        ...
                                        <input type="text" data-kt-filemanager-table-filter="search"
                                            ...
                                            placeholder="Search Context Analysis" id="termino" name="termino" />
                                    </div>
                                    <!--end::Search-->
                                </div>
                                ...
                                <div class="col-9">
                                    <div class="d-flex justify-content-end mr-2">
                                        <a href="/context-analysis-add.php" class="btn btn-sm btn-primary mt-4 me-3">
                                            Create
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="card-body pt-0 table-responsive">
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5 gx-5"
                                    ...
                                    <thead>
                                        ...
                                        <tr class="text-start text-gray-400 text-uppercase gs-0" data-height="30">
                                            <th class="min-w-100px">
                                               <!--  <a
                                                    href="/context-analysis.php?a=strategicAnalysis&column=year&order=<?php echo $asc_or_desc; ?>&sorting_status=true">
                                                    Year<i
                                            ...
                                            <!--     <a
                                                    href="/context-analysis.php?a=strategicAnalysis&column=revision&order=<?php echo $asc_or_desc; ?>&sorting_status=true">
                                                    Revision<i
                                          ...
                                          <!--    <th class="min-w-150px">
                                            ...
                                            <th class="min-w-150px">
                                                <!-- <a
                                                    href="/context-analysis.php?a=strategicAnalysis&column=revision_date&order=<?php echo $asc_or_desc; ?>&sorting_status=true">
                                                    Revision Date<i
                                            ...
                                            <th class="min-w-150px">
                                               <!--  <a
                                                    href="/context-analysis.php?a=strategicAnalysis&column=created_by&order=<?php echo $asc_or_desc; ?>&sorting_status=true">
                                                    Created By<i
                                            ...
                                            <th class="min-w-150px">
                                                <!-- <a
                                                    href="/context-analysis.php?a=strategicAnalysis&column=approved_by&order=<?php echo $asc_or_desc; ?>&sorting_status=true">
                                                    Approved By<i
                                    ...
                                    <tbody class="fw-bold text-gray-600">
                                        <?php
                                        $sql_data = "SELECT * FROM context_analysis WHERE is_deleted = 0 order by " . $columnsQueryItem[$column] . " " . $sort_order;
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="context-analysis-edit.php?id=<?php echo $result_data['id']; ?>"
                                            ...
                                            <?php } else { ?>
                                            <td>
                                                <a href="context-analysis-view.php?id=<?php echo $result_data['id']; ?>"
    ...
    <script src="JS/buscar-context-analysis.js"></script>
    ...
    function createPagination(totalPages, page) {
        ...
        let lastPage = ">>";
        liTag +=
            `<li class="page-item m-1"><a href="/context-analysis.php?a=strategicAnalysis&page=${1}&limit=${pageLimit}&column=<?php echo $column; ?>&order=${asc_or_desc}" class="page-link">${firstPage}</a></li>`;
        if (page > 1) {
            liTag +=
                `<li class="page-item m-1"><a href="/context-analysis.php?a=strategicAnalysis&page=${page - 1}&limit=${pageLimit}&column=<?php echo $column; ?>&order=${asc_or_desc}" class="page-link">${prevLabel}</a></li>`;
        }
        if (page == totalPages) {
        ...
        for (var plength = beforePage; plength <= afterPage; plength++) {
            ...
            liTag +=
                `<li class="page-item m-1 ${active}"><a href="/context-analysis.php?a=strategicAnalysis&page=${plength}&limit=${pageLimit}&column=<?php echo $column; ?>&order=${asc_or_desc}" class="page-link">${plength}</a></li>`;
        }
        if (page < totalPages) {
            liTag +=
                `<li class="page-item m-1"><a href="/context-analysis.php?a=strategicAnalysis&page=${page + 1}&limit=${pageLimit}&column=<?php echo $column; ?>&order=${asc_or_desc}" class="page-link">${nextLabel}</a></li>`;
        }
        liTag +=
            `<li class="page-item m-1"><a href="/context-analysis.php?a=strategicAnalysis&page=${totalPages}&limit=${pageLimit}&column=<?php echo $column; ?>&order=${asc_or_desc}" class="page-link">${lastPage}</a></li>`;
    ...
    $('.print-pdf').on('click', function() {
        ...
        $.get(`/includes/context_analysis_pdf.php?id=${id}`, function(data) {
            let opt = {
