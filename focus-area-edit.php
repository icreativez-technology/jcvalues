...
$_SESSION['Page_Title'] = "Edit Focus Area";
$sqlData = "SELECT title FROM focus_area WHERE id LIKE '$_REQUEST[id]'";
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                ...
                <div class="breadcrumbs">
                    ...
                    <div>
                        <!--begin::Title-->
                        <div>
                            <p><a href="/">Home</a> » <a href="/admin-panel.php">Admin Panel</a> » <a href="/kaizen.php">Kaizen</a> » <a href="/focus-area.php">Focus Area</a> » <?php echo $_SESSION['Page_Title']; ?></p>
                        </div>
                    </div>
                    <!--end::body-->
                </div>
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    ...
                    <div class="container-custom" id="kt_content_container">
                        ...
                        <div class="card card-custom gutter-b example example-compact">
                            ...
                            <!--begin::Form-->
                            <form action="includes/focus-area-update.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row mt-3 ms-6 mb-6">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <a href="/focus-area.php" class="btn btn-sm btn-danger mt-3 ms-2">Cancel</a>
                                    </div>
                                </div>
                            </form>
                            <!--end::Form-->
