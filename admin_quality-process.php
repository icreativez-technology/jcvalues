...
$_SESSION['Page_Title'] = "Quality Process Management";
...
<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed aside-fixed aside-secondary-disabled">
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    ...
                    <div class="container-custom" id="kt_content_container">
                        ...
                        <div class="card">
                            ...
                            <!--Add form-->
                            <form action="includes/basicsettings_quality-process_add.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <?php if (isset($_GET['exist'])) { ?>
                                                <small class="text-danger">The process name has already been taken</small>
                                            <?php } ?>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                            ...
                            <div class="pt-3 ms-5 mb-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 d-flex align-items-center position-relative my-1">
                                        ...
                                        <!--end::Svg Icon-->
                                        <input type="text" data-kt-filemanager-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Search Quality Process" id="termino" name="termino" />
                                    </div>
                                    <!--end::Search-->
                                </div>
                                <!--begin::Card title-->
                                    ...
                                    <tbody class="fw-bold text-gray-600">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <!--begin::Modified=-->
                                                <td>
                                                    <?php echo $result_data['Modified'] != null ? date("d-m-y", strtotime($result_data['Modified'])) : ''; ?>
                                                </td>
                                                <!--end::Modified=-->

                                                <!--begin::Status=-->
                                                <?php if ($result_data['status'] == 'Active') { ?>
                                                    <td><a href="/includes/basicsettings_quality-process_status.php?pg_id=<?php echo $result_data['Id_quality_process']; ?>">
                                                ...
                                                <!--begin::Action=-->
                                                <td class="text-end">
                                                    <a href="/admin_quality-process-edit.php?pg_id=<?php echo $result_data['Id_quality_process']; ?>"><i class="bi bi-pencil" style="padding-right: 4px;"></i></a>
                                                    <?php if ($role == 1) { ?>
                                                        <a href="/admin_quality-process-delete.php?pg_id=<?php echo $result_data['Id_quality_process']; ?>"><i class="bi bi-trash" style="padding-right: 4px;"></i></a>
                                                    <?php } ?>
                                                </td>
                                                <!--end::Action=-->
                                            </tr>
    ...
    <!-- BUSCADOR SEARCH PARA: Quality Process -->
    <script src="JS/buscar-quality-process.js"></script>
    ...
    <script>
        ...
        function createPagination(totalPages, page) {
            ...
            let lastPage = ">>";
            liTag +=
                `<li class="page-item m-1"><a href="/admin_quality-process.php?page=${1}&limit=${pageLimit}" class="page-link">${firstPage}</a></li>`;
            if (page > 1) {
                liTag +=
                    `<li class="page-item m-1"><a href="/admin_quality-process.php?page=${page - 1}&limit=${pageLimit}" class="page-link">${prevLabel}</a></li>`;
            }
            if (page == totalPages) {
            ...
            for (var plength = beforePage; plength <= afterPage; plength++) {
                ...
                liTag +=
                    `<li class="page-item m-1 ${active}"><a href="/admin_quality-process.php?page=${plength}&limit=${pageLimit}" class="page-link">${plength}</a></li>`;
            }
            if (page < totalPages) {
                liTag +=
                    `<li class="page-item m-1"><a href="/admin_quality-process.php?page=${page + 1}&limit=${pageLimit}" class="page-link">${nextLabel}</a></li>`;
            }
            liTag +=
                `<li class="page-item m-1"><a href="/admin_quality-process.php?page=${totalPages}&limit=${pageLimit}" class="page-link">${lastPage}</a></li>`;
