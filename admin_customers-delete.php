...
$_SESSION['Page_Title'] = "Delete Customer";
				...
				<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
					...
					<div class="row breadcrumbs">
						...
						<div>
							<!--begin::Title-->
							<div>
								<p><a href="/">Home</a> » <a href="/admin-panel.php">Admin Panel</a> » <a href="/admin_customers-panel.php">Customers Management</a> » <?php echo $_SESSION['Page_Title']; ?></p>
							</div>
						</div>
						<!--end::body-->
					</div>
					...
					<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
						...
						<div class="container-custom" id="kt_content_container">
                         ...
                         <div class="card card-custom gutter-b example example-compact">
											...
											<!--begin::Form-->
											<form class="form" action="includes/basicsettings_customers_delete.php"  method="post" enctype="multipart/form-data">
												<input type="hidden" name="pg_id" id="pg_id" value="<?php echo $result_data['Id_customer']; ?>" readonly>
												<div class="card-body">
													
													<div class="form-group row">
														<div class="col-lg-12" style="text-align: center;">
															<label>¿Are you sure you want to delete <?php echo $result_data['Customer_Name'];?> customer data?</label><br>
