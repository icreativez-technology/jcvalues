...
$_SESSION['Page_Title'] = "View Objective - " . $resultData['year'];
?>
<!DOCTYPE html>
<html lang="en">
                        ...
                        <div class="card card-flush">
                                            ...
                                            <tbody class="text-gray-600 fw-bold" id="list-table">
                                                ...
                                                <tr>
                                                    <td><input type="text" class="form-control"
                                                            value="<?php echo $list['objective']; ?>" disabled></td>
                                                    <?php
                                                            $sql = "SELECT * From Basic_Employee Where Id_employee = $list[responsible]";
                                                            $fetch = mysqli_query($con, $sql);
                                                            $respInfo = mysqli_fetch_assoc($fetch);
                                                            ?>
                                                    <td><input type="text" class="form-control"
                                                            value="<?php echo $respInfo['First_Name'] . ' ' . $respInfo['Last_Name']; ?>"
                                                            disabled></td>
                                                    <td><input class="form-check-input ms-6 mt-5 check-size"
                                                            type="checkbox"
                                                            <?php echo $list['comply_level'] == "Yes" ? "checked" : ""; ?>
                                                            disabled></td>
                                                </tr>
                                                <?php }
                                                } ?>
                            ...
                            <div class="card-footer">
                                <div class="row" style="text-align:center; float:right;">
                                    <div class="mb-4">
                                        <a type="button" href="/objective.php"
