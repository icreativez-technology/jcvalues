...
$_SESSION['Page_Title'] = "Usage Condition Management";
...
<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed aside-fixed aside-secondary-disabled">
	...
	<div class="d-flex flex-column flex-root">
				...
				<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
					...
					<div class="container-custom" id="kt_content_container">
						...
						<div class="card">
							...
							<!--Add form-->
							<form action="includes/basicsettings_asset-usage_add.php" method="post" enctype="multipart/form-data">
									...
									<div class="col-md-5">
										<div class="form-group">
											...
											<?php if (isset($_GET['exist'])) { ?>
												<small class="text-danger">The usage condition name has already been taken</small>
											<?php } ?>
										</div>
									</div>
									<div class="col-md-2">
							...
							<div class="card-body pt-0 table-responsive">
								...
								<table class="table align-middle table-row-dashed fs-6 gy-5 gx-5">
									...
									<tbody class="fw-bold text-gray-600">
										<?php
										$sql_data = "SELECT * FROM Asset_Usage_Condition";
										...
										?>
											<tr>
												...
												<?php if ($result_data['Status'] == 'Active') { ?>
													<td><a href="/includes/basicsettings_asset-usage_status?pg_id=<?php echo $result_data['Id_asset_usage_condition']; ?>">
												...
												<!--begin::Action=-->
												<td class="text-end">
													<a href="/admin_asset-usage-edit.php?pg_id=<?php echo $result_data['Id_asset_usage_condition']; ?>"><i class="bi bi-pencil" style="padding-right: 4px;"></i></a>
													<?php if ($role == 1) { ?>
														<a href="/admin_asset-usage-delete.php?pg_id=<?php echo $result_data['Id_asset_usage_condition']; ?>"><i class="bi bi-trash" style="padding-right: 4px;"></i></a>
													<?php } ?>
												</td>
												<!--end::Action=-->
											</tr>
		...
		<!-- BUSCADOR SEARCH PARA: Usage Condition -->
		<script src="JS/buscar-asset-usage.js"></script>
		...
		<script>
			...
			function createPagination(totalPages, page) {
				...
				let lastPage = ">>";
				liTag +=
					`<li class="page-item m-1"><a href="/admin_asset-usage.php?page=${1}" class="page-link">${firstPage}</a></li>`;
				if (page > 1) {
					liTag +=
				...
				liTag +=
					`<li class="page-item m-1"><a href="/admin_asset-usage.php?page=${totalPages}" class="page-link">${lastPage}</a></li>`;
