...
$_SESSION['Page_Title'] = "Diffuser Type";
?>
<!DOCTYPE html>
<html lang="en">
...
<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed aside-fixed aside-secondary-disabled">
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    ...
                    <div class="container-custom" id="kt_content_container">
                        ...
                        <div class="card">
                            <!--Add form-->
                            <form action="includes/vt-diffuser-type-add.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <?php if (isset($_GET['exist'])) { ?>
                                                <small class="text-danger">The diffuser type name has already been
                                                    taken</small>
                                            <?php } ?>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body pt-0 table-responsive">
                                <table class="table align-middle table-row-dashed fs-6 gy-5 gx-5" id="kt_department_table">
                                    ...
                                    <tbody class="fw-bold text-gray-600">
                                        <?php
                                        $sql_data = "SELECT * FROM vt_diffuser_type order by id DESC";
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <?php if ($result_data['status'] == "1") { ?>
                                                    <td>
                                                        <a href="/includes/vt-diffuser-type-status.php?id=<?php echo $result_data['id']; ?>">
                                                ...
                                                <?php } ?>
                                                <td class="text-end">
                                                    <a href="/vt-diffuser-type-edit.php?id=<?php echo $result_data['id']; ?>"><i class="bi bi-pencil"></i></a>
                                                </td>
                                            </tr>
                                        <?php
                                        }
    ...
    <script>
        ...
        function createPagination(totalPages, page) {
            ...
            let lastPage = ">>";
            liTag +=
                `<li class="page-item m-1"><a href="/vt-diffuser-type.php?page=${1}" class="page-link">${firstPage}</a></li>`;
            if (page > 1) {
                liTag +=
                    `<li class="page-item m-1"><a href="/vt-diffuser-type.php?page=${page - 1}" class="page-link">${prevLabel}</a></li>`;
            }
            if (page == totalPages) {
            ...
            for (var plength = beforePage; plength <= afterPage; plength++) {
                ...
                liTag +=
                    `<li class="page-item m-1 ${active}"><a href="/vt-diffuser-type.php?page=${plength}" class="page-link">${plength}</a></li>`;
            }
            if (page < totalPages) {
                liTag +=
                    `<li class="page-item m-1"><a href="/vt-diffuser-type.php?page=${page + 1}" class="page-link">${nextLabel}</a></li>`;
            }
            liTag +=
                `<li class="page-item m-1"><a href="/vt-diffuser-type.php?page=${totalPages}" class="page-link">${lastPage}</a></li>`;
