...
$columns = array('id', 'created_by', 'created_at', 'plant', 'product_group', 'department', 'type', 'status');
...
<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed aside-fixed aside-secondary-disabled">
        ...
        <div class="page d-flex flex-row flex-column-fluid">
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                ...
                <div class="row breadcrumbs">
                    <div class="col-6">
                        <p><a href="/">Home</a> » <a href="/quality-moc.php">Quality MoC</a> »
                        ...
                        <div class="card mt-4">
                                ...
                                <div class="col-3">
                                  ...
                                  <!--   <div class="d-flex align-items-center position-relative my-1">
                                        ...
                                        <input type="text" data-kt-filemanager-table-filter="search"
                                            ...
                                            placeholder="Search Quality MoC" id="termino" name="termino" />
                                    </div> -->
                                    <!--end::Search-->
                                </div>
                                <div class="col-9">
                                    <div class="d-flex justify-content-end mr-2">
                                        ...
                                        <button id="btnExport" onclick="fnExcelReport('MoC.xlsx');"
                            ...
                            <div class="card-body pt-0 table-responsive">
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5 gx-5"
                                    id="kt_department_table" data-cols-width="20,20,10, 20, 20, 20, 10, 10">
                                    <!--begin::Table head-->
                                    <thead>
                                        <!--begin::Table row-->
                                        <tr class="text-start text-gray-400 text-uppercase gs-0" data-height="30">
                                            <th class="min-w-150px">
                                                <!-- <a
                                                    href="/quality-moc_view_list.php?a=moc&column=id&order=<?php echo $asc_or_desc; ?>&sorting_status=true">
                                                    Unique ID<i
                                            ...
                                            <th class="min-w-150px">
                                               <!--  <a
                                                    href="/quality-moc_view_list.php?a=moc&column=created_by&order=<?php echo $asc_or_desc; ?>&sorting_status=true">
                                                    Created By<i
                                            ...
                                            <th class="min-w-100px">
                                                <!-- <a
                                                    href="/quality-moc_view_list.php?a=moc&column=created_at&order=<?php echo $asc_or_desc; ?>&sorting_status=true">
                                                    Created<i
                                            ...
                                            <th class="min-w-100px">
                                                <!-- <a
                                                    href="/quality-moc_view_list.php?a=moc&column=plant&order=<?php echo $asc_or_desc; ?>&sorting_status=true">
                                                    Plant<i
                                            ...
                                            <th class="min-w-150px">
                                                <!-- <a
                                                    href="/quality-moc_view_list.php?a=moc&column=product_group&order=<?php echo $asc_or_desc; ?>&sorting_status=true">
                                                    Product Group<i
                                            ...
                                            <th class="min-w-150px">
                                                <!-- <a
                                                    href="/quality-moc_view_list.php?a=moc&column=department&order=<?php echo $asc_or_desc; ?>&sorting_status=true">
                                                    Department<i
                                            ...
                                            <th class="min-w-150px">
                                                <!-- <a
                                                    href="/quality-moc_view_list.php?a=moc&column=type&order=<?php echo $asc_or_desc; ?>&sorting_status=true">
                                                    MoC Type<i
                                                        class="fas fa-sort<?php echo $column == 'type' ? '-' . $up_or_down : ''; ?>"></i>
                                                </a> -->
                                                MoC Type
                                            </th>
                                            <th class="min-w-100px">
                                                <!-- <a
                                                    href="/quality-moc_view_list.php?a=moc&column=status&order=<?php echo $asc_or_desc; ?>&sorting_status=true">
                                                    Status<i
                                    ...
                                    <tbody class="fw-bold text-gray-600">
                                        <?php
                                        $sql_data = "SELECT quality_moc.*, Basic_Employee.First_Name, Basic_Employee.Last_Name, Basic_Department.Department, Quality_MoC_Type.Title as moc_type, Basic_Product_Group.Title as product_group, Basic_Plant.Title as plant FROM quality_moc 
										...
										WHERE quality_moc.is_deleted = 0 AND quality_moc.moc_id LIKE '%$uniqID%' AND quality_moc.created_at LIKE '%$createDt%' order by " . $columnsQueryItem[$column] . " " . $sort_order;
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php echo $result_data['moc_type']; ?>
                                            </td>
                                            <?php $class = ($result_data['status'] == "Created") ? "status-warning" : (($result_data['status'] == "Approved") ? "status-active" : "status-danger"); ?>
                                            <td>
                                                <div class="<?php echo $class; ?>"><?php echo $result_data['status']; ?>
                                                </div>
                                            </td>
                                            <td>
                                                <?php if ($result_data['status'] == "Created" || $result_data['status'] == "Rejected") { ?>
                                                <?php if ($canEdit == 1) { ?>
                                                <a href="quality-moc-edit.php?id=<?php echo $result_data['id']; ?>"
                                                ...
                                                <a data-id='<?php echo $result_data['id']; ?>'
                                                    data-unique='<?php echo $result_data['moc_id']; ?>' target="_blank"
                                                    class="print-quality-moc-mtc me-3"><i class="bi bi-file-earmark-pdf"
                                                        aria-hidden="true"></i></a>
                                                <?php } ?>
                                                <?php } ?>
                                                <?php if ($canView == 1) { ?>
                                                <a href="quality-moc-edit.php?id=<?php echo $result_data['id']; ?>&type=view"
                                                    class="me-3">
                                                    <i class="bi bi-eye" aria-hidden="true"></i>
                                                </a>
                                                <?php } ?>
                                                <?php if ($role == 1 || $canDelete == 1) { ?>
                                                <a href="/includes/quality-moc-delete.php?id=<?php echo $result_data['id']; ?>"
    ...
    <script src="JS/buscar-quality-moc-view-list.js"></script>
    <!-- FIN BUSCADOR SEARCH JS -->
     ...
     <script>
        ...
        function resetFilter() {
            window.location.href = base_url + '/quality-moc_view_list.php?a=4';
        }
    ...
    function createPagination(totalPages, page) {
        ...
        let lastPage = ">>";
        liTag +=
            `<li class="page-item m-1"><a href="/quality-moc_view_list.php?a=moc&page=${1}&limit=${pageLimit}&column=<?php echo $column; ?>&order=${asc_or_desc}" class="page-link">${firstPage}</a></li>`;
        if (page > 1) {
            liTag +=
                `<li class="page-item m-1"><a href="/quality-moc_view_list.php?a=moc&page=${page - 1}&limit=${pageLimit}&column=<?php echo $column; ?>&order=${asc_or_desc}" class="page-link">${prevLabel}</a></li>`;
        }
        if (page == totalPages) {
        ...
        for (var plength = beforePage; plength <= afterPage; plength++) {
            ...
            liTag +=
                `<li class="page-item m-1 ${active}"><a href="/quality-moc_view_list.php?a=moc&page=${plength}&limit=${pageLimit}&column=<?php echo $column; ?>&order=${asc_or_desc}" class="page-link">${plength}</a></li>`;
        }
        if (page < totalPages) {
            liTag +=
                `<li class="page-item m-1"><a href="/quality-moc_view_list.php?a=moc&page=${page + 1}&limit=${pageLimit}&column=<?php echo $column; ?>&order=${asc_or_desc}" class="page-link">${nextLabel}</a></li>`;
        }
        liTag +=
            `<li class="page-item m-1"><a href="/quality-moc_view_list.php?a=moc&page=${totalPages}&limit=${pageLimit}&column=<?php echo $column; ?>&order=${asc_or_desc}" class="page-link">${lastPage}</a></li>`;
    ...
    $('.print-quality-moc-mtc').on('click', function() {
        let id = $(this).data('id');
        let uniqueId = $(this).data('unique');
        $.get(`/includes/quality_moc_pdf.php?id=${id}`, function(data) {
            let opt = {
