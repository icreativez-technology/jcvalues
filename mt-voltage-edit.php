...
$_SESSION['Page_Title'] = "Edit Voltage";
$sqlData = "SELECT title FROM mt_voltage WHERE id LIKE '$_REQUEST[id]'";
                    ...
                    <div>
                        <div>
                            <p>
                                ...
                                <a href="/mt-voltage.php">Voltage</a> »
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    <div class="container-custom" id="kt_content_container">
                        <div class="card card-custom gutter-b example example-compact">
                            ...
                            <form action="includes/mt-voltage-update.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row mt-3 ms-6 mb-6">
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <small class="text-danger">The voltage name has already been
                                                taken</small>
                                            <?php } ?>
                                        </div>
                                    </div>
                                    <div class="col-md-2 d-flex pt-6">
                                        ...
                                        <a href="/mt-voltage.php" class="btn btn-sm btn-danger mt-3 ms-2">Cancel</a>
                                    </div>
                                </div>
                            </form>
                        </div>
