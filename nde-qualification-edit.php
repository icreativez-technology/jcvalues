...
$_SESSION['Page_Title'] = "Edit Qualification";
$sqlData = "SELECT title FROM nde_qualifications WHERE id LIKE '$_REQUEST[id]'";
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    ...
                    <div class="container-custom" id="kt_content_container">
                        ...
                        <div class="card card-custom gutter-b example example-compact">
                            ...
                            <!--begin::Form-->
                            <form action="includes/nde-qualification-update.php" method="post"
