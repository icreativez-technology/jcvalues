...
$_SESSION['Page_Title'] = "Analysis and Expectations of Interested Parties";
...
<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed aside-fixed aside-secondary-disabled">
                    ...
                    <div class="col-12" >
                        <ul class="nav nav-tabs custom-tab" id="myTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <a href="/interested-parties.php?a=1" class="header-bar nav-link active ms-6">
                            ...
                            <li class="nav-item" role="presentation">
                                <a href="/objective.php?a=1" class="header-bar nav-link">
                                    Objective
                                </a>
                            </li>
                        </ul>
                    ...
                    <div class="container-custom" id="kt_content_container">
                        ...
                        <div class="card">
                            <div class="row mb-4 ms-2">
                                <div class="col-3">
                                    ...
                                    <div class="d-flex align-items-center position-relative my-1">
                                        ...
                                        <!--end::Svg Icon-->
                                        <input type="text" data-kt-filemanager-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Search Interested Parties" id="termino" name="termino" />
                                    </div>
                                    <!--end::Search-->
                                </div>
                                <?php if ($role == 1 || $rep == "Yes") { ?>
                                    <div class="col-9">
                                        <div class="d-flex justify-content-end mr-2">
                                            <a href="/interested-parties-add.php" class="btn btn-sm btn-primary mt-4 me-3">
                                                Create
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body pt-0 table-responsive">
                                <!--begin::Table-->
                                <table class="table align-middle table-row-dashed fs-6 gy-5 gx-5" id="interested-parties-table" data-cols-width="10,10,10, 20, 20">
                                    <!--begin::Table head-->
                                    <thead>
                                        <!--begin::Table row-->
                                        <tr class="text-start text-gray-400 text-uppercase gs-0" data-height="30">
                                            <th class="min-w-100px">
                                                <!-- <a href="/interested-parties.php?a=strategicAnalysis&column=year&order=<?php echo $asc_or_desc; ?>&sorting_status=true">
                                                    Year<i class="fas fa-sort<?php echo $column == 'year' ? '-' . $up_or_down : ''; ?>"></i>
                                                </a> -->
                                                Year
                                            </th>
                                            <th class="min-w-150px">
                                                <!-- <a href="/interested-parties.php?a=strategicAnalysis&column=revision&order=<?php echo $asc_or_desc; ?>&sorting_status=true">
                                                    Revision<i class="fas fa-sort<?php echo $column == 'revision' ? '-' . $up_or_down : ''; ?>"></i>
                                                </a> -->
                                                Revision
                                            </th>
                                            <!--  <th class="min-w-150px">
                                            ...
                                            <th class="min-w-150px">
                                               <!--  <a href="/interested-parties.php?a=strategicAnalysis&column=revision_date&order=<?php echo $asc_or_desc; ?>&sorting_status=true">
                                                    Revision Date<i class="fas fa-sort<?php echo $column == 'revision_date' ? '-' . $up_or_down : ''; ?>"></i>
                                                </a> -->
                                                Revision Date
                                            </th>
                                            <th class="min-w-150px">
                                              <!--   <a href="/interested-parties.php?a=strategicAnalysis&column=created_by&order=<?php echo $asc_or_desc; ?>&sorting_status=true">
                                                    Created By<i class="fas fa-sort<?php echo $column == 'created_by' ? '-' . $up_or_down : ''; ?>"></i>
                                                </a> -->
                                                Created By
                                            </th>
                                            <th class="min-w-150px">
                                              <!--   <a href="/interested-parties.php?a=strategicAnalysis&column=approved_by&order=<?php echo $asc_or_desc; ?>&sorting_status=true">
                                                    Approved By<i class="fas fa-sort<?php echo $column == 'approved_by' ? '-' . $up_or_down : ''; ?>"></i>
                                                </a> -->
                                                Approved By
                                            </th>
                                    ...
                                    <tbody class="fw-bold text-gray-600">
                                        <?php
                                        $sql_data = "SELECT * FROM interested_parties WHERE is_deleted = 0 order by " . $columnsQueryItem[$column] . " " . $sort_order;
                                            ...
                                            <tr>
                                               ...
                                               <!--  <td>
                                                ...
                                                <?php if ($result_data['is_editable'] && ($role == 1 || $rep == "Yes")) { ?>
                                                    <td>
                                                        <a href="interested-parties-edit.php?id=<?php echo $result_data['id']; ?>" class="me-3 set-url"><i class="bi bi-pencil" aria-hidden="true"></i></a>
                                                ...
                                                <?php } else { ?>
                                                    <td>
                                                        <a href="interested-parties-view.php?id=<?php echo $result_data['id']; ?>" class="me-3"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                                        <a data-id='<?php echo $result_data['id']; ?>' data-year='<?php echo $result_data['year']; ?>' data-revision='<?php echo $result_data['revision']; ?>' target="_blank" class="print-interested-parties me-3 cursor-pointer"><i class="bi bi-file-earmark-pdf" aria-hidden="true"></i></a>
                                                    </td>
                                                <?php } ?>
                                            </tr>
    ...
    <script src="JS/buscar-interested-parties.js"></script>
    ...
    <script>
        ...
        function createPagination(totalPages, page) {
            ...
            let lastPage = ">>";
            liTag +=
                `<li class="page-item m-1"><a href="/interested-parties.php?a=strategicAnalysis&page=${1}&limit=${pageLimit}&column=<?php echo $column; ?>&order=${asc_or_desc}" class="page-link">${firstPage}</a></li>`;
            if (page > 1) {
                liTag +=
                    `<li class="page-item m-1"><a href="/interested-parties.phpa=strategicAnalysis&?page=${page - 1}&limit=${pageLimit}&column=<?php echo $column; ?>&order=${asc_or_desc}" class="page-link">${prevLabel}</a></li>`;
            }
            if (page == totalPages) {
            ...
            for (var plength = beforePage; plength <= afterPage; plength++) {
                ...
                liTag +=
                    `<li class="page-item m-1 ${active}"><a href="/interested-parties.php?a=strategicAnalysis&page=${plength}&column=<?php echo $column; ?>&limit=${pageLimit}&order=${asc_or_desc}" class="page-link">${plength}</a></li>`;
            }
            if (page < totalPages) {
                liTag +=
                    `<li class="page-item m-1"><a href="/interested-parties.php?a=strategicAnalysis&page=${page + 1}&column=<?php echo $column; ?>&limit=${pageLimit}&order=${asc_or_desc}" class="page-link">${nextLabel}</a></li>`;
            }
            liTag +=
                `<li class="page-item m-1"><a href="/interested-parties.php?a=strategicAnalysis&page=${totalPages}&column=<?php echo $column; ?>&limit=${pageLimit}&order=${asc_or_desc}" class="page-link">${lastPage}</a></li>`;
            element.innerHTML = liTag;
            return liTag;
        }

        $('.print-interested-parties').on('click', function() {
            let id = $(this).data('id');
            let fileName = $(this).data('year') + "-Revision-" + $(this).data('revision');
            $.get(`/includes/interested_parties_pdf.php?id=${id}`, function(data) {
                let opt = {
