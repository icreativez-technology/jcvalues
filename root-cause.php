...
$_SESSION['Page_Title'] = "Root Cause";
...
<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed aside-fixed aside-secondary-disabled">
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    ...
                    <div class="container-custom" id="kt_content_container">
                        ...
                        <div class="card">
                            ...
                            <form action="includes/root-cause-add.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <?php if (isset($_GET['exist'])) { ?>
                                                <small class="text-danger">The root cause name has already been
                                                    taken</small>
                                            <?php } ?>
                                        </div>
                                    </div>
                            ...
                            <div class="row mt-2 mb-4 ms-2">
                                <div class="col-md-3">
                                    ...
                                    <div class="d-flex align-items-center position-relative my-1">
                                        ...
                                        <!--end::Svg Icon-->
                                        <input type="text" data-kt-filemanager-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Search Root Cause" id="termino" name="termino" />
                                    </div>
                                    <!--end::Search-->
                                </div>
                            </div>
                            ...
                            <div class="card-body pt-0 table-responsive">
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5 gx-5" id="kt_department_table">
                                    ...
                                    <tbody class="fw-bold text-gray-600">
                                        <?php
                                        $sql_data = "SELECT * FROM root_cause WHERE is_deleted = 0 order by id DESC";
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <?php if ($result_data['status'] == "1") { ?>
                                                    <td>
                                                        <a href="/includes/root-cause-status.php?id=<?php echo $result_data['id']; ?>">
                                                ...
                                                <?php } ?>
                                                <td class="text-end">
                                                    <a href="/root-cause-edit.php?id=<?php echo $result_data['id']; ?>" class="me-2"><i class="bi bi-pencil"></i></a>
                                                    <?php if ($role == 1) { ?>
                                                        <a href="/includes/root-cause-delete.php?id=<?php echo $result_data['id']; ?>"><i class="bi bi-trash"></i></a>
                                                    <?php } ?>
                                                </td>
                                            </tr>
                                        <?php
    ...
    <script src="JS/buscar-root-cause.js"></script>
    ...
    <script>
        ...
        function createPagination(totalPages, page) {
            ...
            let lastPage = ">>";
            liTag +=
                `<li class="page-item m-1"><a href="/root-cause.php?page=${1}&limit=${pageLimit}" class="page-link">${firstPage}</a></li>`;
            if (page > 1) {
                liTag +=
                    `<li class="page-item m-1"><a href="/root-cause.php?page=${page - 1}&limit=${pageLimit}" class="page-link">${prevLabel}</a></li>`;
            }
            if (page == totalPages) {
            ...
            for (var plength = beforePage; plength <= afterPage; plength++) {
                ...
                liTag +=
                    `<li class="page-item m-1 ${active}"><a href="/root-cause.php?page=${plength}&limit=${pageLimit}" class="page-link">${plength}</a></li>`;
            }
            if (page < totalPages) {
                liTag +=
                    `<li class="page-item m-1"><a href="/root-cause.php?page=${page + 1}&limit=${pageLimit}" class="page-link">${nextLabel}</a></li>`;
            }
            liTag +=
                `<li class="page-item m-1"><a href="/root-cause.php?page=${totalPages}&limit=${pageLimit}" class="page-link">${lastPage}</a></li>`;
