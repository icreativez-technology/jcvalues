...
$_SESSION['Page_Title'] = "Edit Equipment For Remote VT";
$sqlData = "SELECT title FROM vt_equipment_for_remote WHERE id LIKE '$_REQUEST[id]'";
                    ...
                    <div>
                        <div>
                            <p>
                                ...
                                <a class="cursor-pointer" data-bs-toggle="modal"
                                    data-bs-target="#admin-menu-modal">Visual Test</a> »
                                <a href="/vt-equipment-for-remote.php">Equipment For Remote VT</a> »
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    <div class="container-custom" id="kt_content_container">
                        <div class="card card-custom gutter-b example example-compact">
                            ...
                            <form action="includes/vt-equipment-for-remote-update.php" method="post"
                                ...
                                <div class="row mt-3 ms-6 mb-6">
                                    ...
                                    <div class="col-md-2 d-flex pt-6">
                                        ...
                                        <a href="/vt-equipment-for-remote.php"
