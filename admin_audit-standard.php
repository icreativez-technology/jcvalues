...
$_SESSION['Page_Title'] = "Audit Standard";
...
<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed aside-fixed aside-secondary-disabled">
		...
		<div class="page d-flex flex-row flex-column-fluid">
			...
			<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
				...
				<div class="row breadcrumbs">
					<div class="col-lg-6">
						<p><a href="/">Home</a> » <a href="/admin-panel.php">Admin Panel</a> » <a href="/admin_audit-panel.php">Audits</a> » <?php echo $_SESSION['Page_Title']; ?></p>
					</div>
				</div>
				...
				<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
					...
					<div class="container-custom" id="kt_content_container">
						...
						<div class="card">
							...
							<!--Add form-->
							<form action="includes/basicsettings_audit-standard_add.php" method="post" enctype="multipart/form-data">
									...
									<div class="col-md-5">
										<div class="form-group">
											...
											<?php if (isset($_GET['exist'])) { ?>
												<small class="text-danger">The audit standard name has already been taken</small>
											<?php } ?>
										</div>
									</div>
									<div class="col-md-2">
							...
							<div class="card-body pt-0 table-responsive">
								...
								<table class="table align-middle table-row-dashed fs-6 gy-5 gx-5" id="kt_department_table">
									...
									<tbody class="fw-bold text-gray-600">
										<?php
										$sql_data = "SELECT * FROM audit_standard WHERE deleted_at IS NULL order by Id_audit_standard DESC";
										...
										?>
											<tr>
												...
												<?php if ($result_data['Status'] == 1) { ?>
													<td><a href="/includes/basicsettings_audit-standard_status.php?pg_id=<?php echo $result_data['Id_audit_standard']; ?>">
												...
												<td>
													<a href="/admin_audit-standard-edit.php?id=<?php echo $result_data['Id_audit_standard']; ?>" class="me-2"><i class="bi bi-pencil"></i></a>
													<?php if ($role == 1) { ?>
														<a href="/includes/basicsettings_audit-standard_delete.php?id=<?php echo $result_data['Id_audit_standard']; ?>"><i class="bi bi-trash"></i></a>
													<?php } ?>
												</td>
											</tr>
										<?php
	...
	<script src="JS/buscar-audit-standard.js"></script>
	...
	<script>
		...
		function createPagination(totalPages, page) {
			...
			let lastPage = ">>";
			liTag +=
				`<li class="page-item m-1"><a href="/admin_audit-standard.php?page=${1}&limit=${pageLimit}" class="page-link">${firstPage}</a></li>`;
			if (page > 1) {
				liTag +=
					`<li class="page-item m-1"><a href="/admin_audit-standard.php?page=${page - 1}&limit=${pageLimit}" class="page-link">${prevLabel}</a></li>`;
			}
			if (page == totalPages) {
			...
			for (var plength = beforePage; plength <= afterPage; plength++) {
				...
				liTag +=
					`<li class="page-item m-1 ${active}"><a href="/admin_audit-standard.php?page=${plength}&limit=${pageLimit}" class="page-link">${plength}</a></li>`;
			}
			if (page < totalPages) {
				liTag +=
					`<li class="page-item m-1"><a href="/admin_audit-standard.php?page=${page + 1}&limit=${pageLimit}" class="page-link">${nextLabel}</a></li>`;
			}
			liTag +=
				`<li class="page-item m-1"><a href="/admin_audit-standard.php?page=${totalPages}&limit=${pageLimit}" class="page-link">${lastPage}</a></li>`;
