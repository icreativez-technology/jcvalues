...
$_SESSION['Page_Title'] = "Plant Management";
...
$columns = array('title', 'created_at', 'modified_at', 'status');
...
<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed aside-fixed aside-secondary-disabled">
                    ...
                    <div class="container-custom" id="kt_content_container">
                        ...
                        <div class="card">
                            ...
                            <div class="row mt-2 mb-4 ms-2">
                                <div class="col-md-3">
                                    ...
                                    <div class="d-flex align-items-center position-relative my-1">
                                        ...
                                        <!--end::Svg Icon-->
                                        <input type="text" data-kt-filemanager-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Search Plants" id="termino" name="termino">
                                    </div>
                                    <!--end::Search-->
                                </div>
                                <div class="col-lg-9">
                                    <div class="d-flex justify-content-end mr-2">
                                        <a href="/admin_plants-add.php" id="add_mtc" class="btn btn-sm btn-primary mt-4" style="float:right ; margin-right:10px;">
                                            Create
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="card-body pt-0 table-responsive">
                                <!--begin::Table-->
                                <table class="table align-middle table-row-dashed fs-6 gy-5 gx-5" id="kt_Plants_table">
                                    <!--begin::Table head-->
                                    <thead>
                                        <!--begin::Table row-->
                                    ...
                                    <tbody class="fw-bold text-gray-600">
                                        <?php
                                        $sql_data = "SELECT Id_plant, Title, Created, Modified, Status FROM Basic_Plant order by " . $columnsQueryItem[$column] . " " . $sort_order;
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <?php if ($result_data['Status'] == 'Active') { ?>
                                                    <td><a href="/includes/basicsettings_plants_status.php?pg_id=<?php echo $result_data['Id_plant']; ?>">
                                                ...
                                                <!--begin::Action=-->
                                                <td class="text-end">
                                                    <a href="/admin_plants-edit.php?pg_id=<?php echo $result_data['Id_plant']; ?>&view"><i class="bi bi-eye" style="padding-right: 4px;"></i></a>
                                                    <a href="/admin_plants-edit.php?pg_id=<?php echo $result_data['Id_plant']; ?>"><i class="bi bi-pencil" style="padding-right: 4px;"></i></a>
                                                    <?php if ($role == 1) { ?>
                                                        <a href="/admin_plants-delete.php?pg_id=<?php echo $result_data['Id_plant']; ?>"><i class="bi bi-trash" style="padding-right: 4px;"></i></a>
                                                    <?php } ?>
                                                </td>
                                                <!--end::Action=-->
                                            </tr>
    ...
    <!-- BUSCADOR SEARCH PARA: Plant -->
    <script src="JS/buscar-plants.js"></script>
    ...
    <script>
        ...
        function createPagination(totalPages, page) {
            ...
            let lastPage = ">>";
            liTag +=
                `<li class="page-item m-1"><a href="/admin_plants-panel.php?page=${1}&limit=${pageLimit}" class="page-link">${firstPage}</a></li>`;
            if (page > 1) {
                liTag +=
                    `<li class="page-item m-1"><a href="/admin_plants-panel.php?page=${page - 1}&limit=${pageLimit}" class="page-link">${prevLabel}</a></li>`;
            }
            if (page == totalPages) {
            ...
            for (var plength = beforePage; plength <= afterPage; plength++) {
                ...
                liTag +=
                    `<li class="page-item m-1 ${active}"><a href="/admin_plants-panel.php?page=${plength}&limit=${pageLimit}" class="page-link">${plength}</a></li>`;
            }
            if (page < totalPages) {
                liTag +=
                    `<li class="page-item m-1"><a href="/admin_plants-panel.php?page=${page + 1}&limit=${pageLimit}" class="page-link">${nextLabel}</a></li>`;
            }
            liTag +=
                `<li class="page-item m-1"><a href="/admin_plants-panel.php?page=${totalPages}&limit=${pageLimit}" class="page-link">${lastPage}</a></li>`;
