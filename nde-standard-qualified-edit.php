...
$_SESSION['Page_Title'] = "Edit Standard Qualified";
$sqlData = "SELECT title FROM nde_standard_qualifieds WHERE id LIKE '$_REQUEST[id]'";
                    ...
                    <div>
                        ...
                        <div>
                            <p><a href="/">Home</a> » <a class="cursor-pointer" data-bs-toggle="modal"
                                    ...
                                    href="/nde-standard-qualified.php">Standard Qualified</a> »
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    ...
                    <div class="container-custom" id="kt_content_container">
                        ...
                        <div class="card card-custom gutter-b example example-compact">
                            ...
                            <!--begin::Form-->
                            <form action="includes/nde-standard-qualified-update.php" method="post"
                                ...
                                <div class="row mt-3 ms-6 mb-6">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <a href="/nde-standard-qualified.php"
