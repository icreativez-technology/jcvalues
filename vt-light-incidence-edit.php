...
$_SESSION['Page_Title'] = "Edit Light Incidence";
$sqlData = "SELECT title FROM vt_light_incidence WHERE id LIKE '$_REQUEST[id]'";
                    ...
                    <div>
                        <div>
                            <p>
                                ...
                                <a href="/vt-light-incidence.php">Light Incidence</a> »
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    <div class="container-custom" id="kt_content_container">
                        <div class="card card-custom gutter-b example example-compact">
                            ...
                            <form action="includes/vt-light-incidence-update.php" method="post"
