...
$_SESSION['Page_Title'] = "Edit Audit Area";
...
$sqlArea = "SELECT * FROM admin_audit_area WHERE id = '$_REQUEST[id]' AND is_deleted = 0";
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    ...
                    <div class="container-custom" id="kt_content_container">
                        <div class="card card-custom gutter-b example example-compact">
                            <form class="form" action="includes/admin_audit_area_update.php" method="post" enctype="multipart/form-data">
                                <div class="card-body">
                                    <div class="form-group row">
                                        <div class="col-lg-3">
                                            <input type="hidden" name="admin_audit_area_id" value="<?php echo $areaDetailsData['id'] ?>">
                                            <label class="required">Audit Area</label>
                                            <input type="text" class="form-control" name="audit_area" value="<?php echo $areaDetailsData['audit_area'] ?>" required>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <select class="form-control" name="audit_standard_id" required>
                                                ...
                                                ?>
                                                    <option value="<?php echo $result_data['id']; ?>" <?php echo ($areaDetailsData['audit_standard_id'] == $result_data['id']) ? 'selected' : ''; ?>>
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <input type="text" class="form-control" name="audit_check_list_format_no" value="<?php echo $areaDetailsData['audit_check_list_format_no'] ?>" required>
                                        </div>
                                        <div class="col-lg-3">
                                            <label class="required">Revision No</label>
                                            <input type="text" class="form-control" name="revision_no" value="<?php echo $areaDetailsData['revision_no'] ?>" required>
                                        </div>
                                    </div>
                                    <div class="form-group row mt-3">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <select class="form-control" name="department_id" id="department" required>
                                                ...
                                                while ($result_data = mysqli_fetch_assoc($connect_data)) {
                                                ?>
                                                    <option value="<?php echo $result_data['Id_department']; ?>" <?php echo ($areaDetailsData['department_id'] == $result_data['Id_department']) ? 'selected' : ''; ?>>
                                        ...
                                        <tbody class="fw-bold text-gray-600" id="list-table">
                                            ...
                                            <?php if ($lists && count($lists) > 0) {
                                                foreach ($lists as $key => $list) { ?>
                                                    <tr id="<?php echo $key  ?>">
                                                        <td><input type="hidden" class="form-control" name="clause[]" value="<?php echo $list['clause']; ?>" required>
