...
$_SESSION['Page_Title'] = "Audit Standard List";
...
<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed aside-fixed aside-secondary-disabled">
                            ...
                            <div class="row mt-2 mb-4 ms-2">
                                <div class="col-md-3">
                                    <div class="d-flex align-items-center position-relative my-1">
                                        ...
                                        <input type="text" data-kt-filemanager-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Search Audit Standard" id="termino" name="termino">
                                    </div>
                                </div>
                                <div class="col-lg-9">
                                    <div class="d-flex justify-content-end mr-2">
                                        <a href="/admin_audit_standard_add.php" id="add_mtc" class="btn btn-sm btn-primary mt-4" style="float:right ; margin-right:10px;">
                                            Create
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="card-body pt-0 table-responsive">
                                <table class="table align-middle table-row-dashed fs-6 gy-5 gx-5" id="kt_suppliers_table">
                                    ...
                                    <tbody class="fw-bold text-gray-600">
                                        <?php
                                        $sql_data = "SELECT * FROM admin_audit_standard WHERE is_deleted = 0 order by id DESC";
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <?php $class = ($result_data['status'] == "Active") ? "status-active" : "status-danger"; ?>
                                                <td>
                                                    <a href="/includes/admin_audit_standard_status.php?id=<?php echo $result_data['id']; ?>">
                                                ...
                                                <td class="text-end">
                                                    <a href="/admin_audit_standard_edit.php?id=<?php echo $result_data['id']; ?>" class="me-2"><i class="bi bi-pencil"></i></a>
                                                    <?php if ($role == 1) { ?>
                                                        <a href="/includes/admin_audit_standard_delete.php?id=<?php echo $result_data['id']; ?>"><i class="bi bi-trash"></i></a>
                                                    <?php } ?>
                                                </td>
                                            </tr>
                                        <?php
    ...
    <script src="JS/buscar_admin_audit_standard.js"></script>
    <script>
        ...
        function createPagination(totalPages, page) {
            ...
            let lastPage = ">>";
            liTag +=
                `<li class="page-item m-1"><a href="/admin_audit_standard.php?page=${1}" class="page-link">${firstPage}</a></li>`;
            if (page > 1) {
                liTag +=
                    `<li class="page-item m-1"><a href="/admin_audit_standard.php?page=${page - 1}" class="page-link">${prevLabel}</a></li>`;
            }
            if (page == totalPages) {
            ...
            for (var plength = beforePage; plength <= afterPage; plength++) {
                ...
                liTag +=
                    `<li class="page-item m-1 ${active}"><a href="/admin_audit_standard.php?page=${plength}" class="page-link">${plength}</a></li>`;
            }
            if (page < totalPages) {
                liTag +=
                    `<li class="page-item m-1"><a href="/admin_audit_standard.php?page=${page + 1}" class="page-link">${nextLabel}</a></li>`;
            }
            liTag +=
                `<li class="page-item m-1"><a href="/admin_audit_standard.php?page=${totalPages}" class="page-link">${lastPage}</a></li>`;
