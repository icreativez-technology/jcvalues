...
$_SESSION['Page_Title'] = "Customer Disposition";
...
<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed aside-fixed aside-secondary-disabled">
				...
				<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
					...
					<div class="container-custom" id="kt_content_container">
						...
						<div class="card">
							...
							<!--Add form-->
							<form action="includes/basicsettings_cm-disposition_add.php" method="post" enctype="multipart/form-data">
								<div class="row mt-6 ms-2">
									<div class="col-md-5">
										<div class="form-group">
											<label>Customer Disposition</label>
											<input type="text" class="form-control" name="title" required>
											<?php if (isset($_GET['exist'])) { ?>
												<small class="text-danger">The customer disposition name has already been taken</small>
											<?php } ?>
										</div>
									</div>
									<div class="col-md-2">
							...
							<div class="pt-6 ms-5 mb-5">
								...
								<div class="row">
									...
									<div class="col-md-6 d-flex align-items-center position-relative my-1">
										...
										<!--end::Svg Icon-->
										<input type="text" data-kt-filemanager-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Search Customer Disposition" id="termino" name="termino" />
									</div>
									<!--end::Search-->
								</div>
								<!--begin::Card title-->
							...
							<div class="card-body pt-0 table-responsive">
								...
								<table class="table align-middle table-row-dashed fs-6 gy-5 gx-5">
									...
									<tbody class="fw-bold text-gray-600">
										<?php
										$sql_data = "SELECT * FROM Customer_Disposition";
										...
										?>
											<tr>
												...
												<?php if ($result_data['Status'] == 'Active') { ?>
													<td><a href="/includes/basicsettings_cm-disposition_status.php?pg_id=<?php echo $result_data['Id_customer_diposition']; ?>">
												...
												<!--begin::Action=-->
												<td class="text-end">
													<a href="/admin_cm-disposition-edit.php?pg_id=<?php echo $result_data['Id_customer_diposition']; ?>"><i class="bi bi-pencil" style="padding-right: 4px;"></i></a>
													<?php if ($role == 1) { ?>
														<a href="/admin_cm-disposition-delete.php?pg_id=<?php echo $result_data['Id_customer_diposition']; ?>"><i class="bi bi-trash" style="padding-right: 4px;"></i></a>
													<?php } ?>
												</td>
												<!--end::Action=-->
											</tr>
	...
	<!-- BUSCADOR SEARCH PARA: Customer Disposition -->
	<script src="JS/buscar-cm-disposition.js"></script>
	...
	<script>
		...
		function createPagination(totalPages, page) {
			...
			let lastPage = ">>";
			liTag +=
				`<li class="page-item m-1"><a href="/admin_cm-disposition.php?page=${1}" class="page-link">${firstPage}</a></li>`;
			if (page > 1) {
				liTag +=
					`<li class="page-item m-1"><a href="/admin_cm-disposition.php?page=${page - 1}" class="page-link">${prevLabel}</a></li>`;
			}
			if (page == totalPages) {
			...
			for (var plength = beforePage; plength <= afterPage; plength++) {
				...
				liTag +=
					`<li class="page-item m-1 ${active}"><a href="/admin_cm-disposition.php?page=${plength}" class="page-link">${plength}</a></li>`;
			}
			if (page < totalPages) {
				liTag +=
					`<li class="page-item m-1"><a href="/admin_cm-disposition.php?page=${page + 1}" class="page-link">${nextLabel}</a></li>`;
			}
			liTag +=
				`<li class="page-item m-1"><a href="/admin_cm-disposition.php?page=${totalPages}" class="page-link">${lastPage}</a></li>`;
