...
$_SESSION['Page_Title'] = "Edit Module";

$sqlData = "SELECT * FROM modules WHERE id = '$_REQUEST[id]' AND is_deleted = 0";
$connectData = mysqli_query($con, $sqlData);
$moduleData = mysqli_fetch_assoc($connectData);
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    ...
                    <div class="container-custom" id="kt_content_container">
                        <div class="card card-custom gutter-b example example-compact">
                            <form class="form" action="includes/add_module_update.php" method="post"
                                enctype="multipart/form-data">
                                <div class="card-body">
                                    <div class="form-group row">
                                        <input type="hidden" name="id" value="<?php echo $moduleData['id'] ?>">
                                        <div class="col-lg-6">
                                            <label class="required">Module Name</label>
                                            <input type="text" class="form-control" name="module"
                                                value="<?php echo $moduleData['module'] ?>" required>
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <input type="Number" class="form-control" name="order"
                                                value="<?php echo $moduleData['module_order'] ?>" required>
                                    ...
                                    <div class="form-group row mt-3">
                                        <div class="col-lg-6">
                                            ...
                                            <textarea type="text" class="form-control" name="description" rows="3"
                                                value="<?php echo $moduleData['description'] ?>"><?php echo $moduleData['description'] ?></textarea>
                                        </div>
                                        <div class="col-lg-6">
                                            <label class="required">href</label>
                                            <input type="text" class="form-control" name="href"
                                                value="<?php echo $moduleData['href'] ?>" required>
                                        </div>
                                    </div>
                                </div>
                                <div class=" p-4">
