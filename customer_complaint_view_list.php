...
$_SESSION['Page_Title'] = "Customer Complaint List";
...
$columns = array('complaint_id', 'created_by', 'customer_name', 'order_ref_no', 'nature_of_complaint', 'status');
...
$columnsQueryItem =    [
    ...
    'order_ref_no' => 'customer_order_ref',
    'nature_of_complaint' => 'Title',
    'status' => 'status'
];
...
<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed aside-fixed aside-secondary-disabled">
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                ...
                <div class="row breadcrumbs">
                    <div class="col-lg-6 col-sm-12">
                        <p><a href="/">Home</a> » <a href="/complaints.php">Customer Complaints</a> »
                            <?php echo $_SESSION['Page_Title']; ?></p>
                    </div>
                    <div class="col-lg-6 col-sm-12">
                        <div class="d-flex justify-content-end">
                            <?php if ($roleInfo['Customer_Compliants_Representatives'] == 'Yes') { ?>
                        ...
                        <div class="card mt-4">
                                ...
                                <div class="col-3">
                                 <!--    <div class="d-flex align-items-center position-relative my-1">
                                        ...
                                        <input type="text" data-kt-filemanager-table-filter="search"
                                            ...
                                            placeholder="Search Customer Complaint" id="termino" name="termino" />
                                    </div> -->
                                </div>
                                <div class="col-9">
                                    <div class="d-flex justify-content-end mr-2">
                                        ...
                                        <button id="btnExport" onclick="fnExcelReport('CustomerComplaint.xlsx');"
                            ...
                            <div class="card-body pt-0 table-responsive">
                                <table class="table align-middle table-row-dashed fs-6 gy-5 gx-5"
                                    id="kt_department_table" data-cols-width="20, 20, 20, 20, 20, 20">
                                    <thead>
                                        <tr class="text-start text-gray-400 text-uppercase gs-0" data-height="30">
                                            <th class="min-w-150px">
                                              <!--   <a
                                                    href="/customer_complaint_view_list.php?a=customerComplaint&column=complaint_id&order=<?php echo $asc_or_desc; ?>&sorting_status=true">
                                                    Unique ID<i
                                                        class="fas fa-sort<?php echo $column == 'complaint_id' ? '-' . $up_or_down : ''; ?>"></i>
                                                </a> -->
                                               Unique ID
                                            ...
                                            <th class="min-w-150px">
                                               <!--  <a
                                                    href="/customer_complaint_view_list.php?a=customerComplaint&column=created_by&order=<?php echo $asc_or_desc; ?>&sorting_status=true">
                                                    Created By<i
                                            ...
                                            <th class="min-w-200px">
                                                <!-- <a
                                                    href="/customer_complaint_view_list.php?a=customerComplaint&column=customer_name&order=<?php echo $asc_or_desc; ?>&sorting_status=true">
                                                    Customer Name<i
                                                        class="fas fa-sort<?php echo $column == 'customer_name' ? '-' . $up_or_down : ''; ?>"></i>
                                                </a> -->
                                                Customer Name
                                            </th>
                                            <th class="min-w-150px">
                                               <!--  <a
                                                    href="/customer_complaint_view_list.php?a=customerComplaint&column=order_ref_no&order=<?php echo $asc_or_desc; ?>&sorting_status=true">
                                                    Order Ref No<i
                                                        class="fas fa-sort<?php echo $column == 'order_ref_no' ? '-' . $up_or_down : ''; ?>"></i>
                                                </a> -->
                                                Order Ref No
                                            </th>
                                            <th class="min-w-200px">
                                                <!-- <a
                                                    href="/customer_complaint_view_list.php?a=customerComplaint&column=nature_of_complaint&order=<?php echo $asc_or_desc; ?>&sorting_status=true">
                                                    Nature of Complaint<i
                                                        class="fas fa-sort<?php echo $column == 'nature_of_complaint' ? '-' . $up_or_down : ''; ?>"></i>
                                                </a> -->
                                                Nature of Complaint
                                            </th>
                                            <th class="min-w-100px">
                                               <!--  <a
                                                    href="/customer_complaint_view_list.php?a=customerComplaint&column=status&order=<?php echo $asc_or_desc; ?>&sorting_status=true">
                                                    Status<i
                                    ...
                                    <tbody class="fw-bold text-gray-600">
                                        <?php
                                        $sql_data = "SELECT customer_complaints.*, Basic_Employee.First_Name, Basic_Employee.Last_Name, Customer_Nature_of_Complaints.Title, Basic_Customer.Customer_Name FROM customer_complaints 
										...
										WHERE customer_complaints.is_deleted = 0 AND customer_complaints.complaint_id LIKE '%$uniqID%' AND customer_complaints.created_at LIKE '%$createDt%' order by " . $columnsQueryItem[$column] . " " . $sort_order;
                                        ...
                                        <tr>
                                            <td>
                                                <?php echo $result_data['complaint_id']; ?>
                                            </td>
                                             <td>
                                            ...
                                            <td>
                                                <?php echo $result_data['customer_order_ref']; ?>
                                            </td>
                                            <td>
                                                <?php echo $result_data['Title']; ?>
                                            </td>
                                            <?php $class = (($result_data['status'] == "Closed") ? "status-active" : "status-danger"); ?>
                                            <td>
                                                <?php echo '<div class="' . $class . '">' . $result_data["status"] . '</div>'; ?>
                                            </td>
                                            <td>
                                                <a href="/customer_complaint_edit.php?id=<?php echo $result_data['id']; ?>&view"
                                                    class="me-3">
                                                    <i class="bi bi-eye" aria-hidden="true"></i>
                                                </a>
                                                <?php if ($result_data['status'] == "Open") { ?>
                                                <a href="customer_complaint_edit.php?id=<?php echo $result_data['id']; ?>"
                                                    class="me-3 set-url"><i class="bi bi-pencil"
                                                        aria-hidden="true"></i></a>
                                                <?php } else { ?>
                                                <a data-id='<?php echo $result_data['id']; ?>'
                                                    data-unique='<?php echo $result_data['complaint_id']; ?>'
                                                    target="_blank" class="me-3 print-pdf cursor-pointer"><i
                                                        class="bi bi-file-earmark-pdf" aria-hidden="true"></i></a>
                                                <?php } ?>
                                                <?php if ($role == 1) { ?>
                                                <a href="/includes/customer_complaint_delete.php?id=<?php echo $result_data['id']; ?>"
    ...
    <script src="JS/buscar_customer_complaint_view_list.js"></script>
    <script>
        ...
        function resetFilter() {
            window.location.href = base_url + '/customer_complaint_view_list.php?a=12';
        }
    ...
    function createPagination(totalPages, page) {
        ...
        let lastPage = ">>";
        liTag +=
            `<li class="page-item m-1"><a href="/customer_complaint_view_list.php?a=customerComplaint&page=${1}&limit=${pageLimit}&column=<?php echo $column; ?>&order=${asc_or_desc}" class="page-link">${firstPage}</a></li>`;
        if (page > 1) {
            liTag +=
                `<li class="page-item m-1"><a href="/customer_complaint_view_list.php?a=customerComplaint&page=${page - 1}&limit=${pageLimit}&column=<?php echo $column; ?>&order=${asc_or_desc}" class="page-link">${prevLabel}</a></li>`;
        }
        if (page == totalPages) {
        ...
        for (var plength = beforePage; plength <= afterPage; plength++) {
            ...
            liTag +=
                `<li class="page-item m-1 ${active}"><a href="/customer_complaint_view_list.php?a=customerComplaint&page=${plength}&limit=${pageLimit}&column=<?php echo $column; ?>&order=${asc_or_desc}" class="page-link">${plength}</a></li>`;
        }
        if (page < totalPages) {
            liTag +=
                `<li class="page-item m-1"><a href="/customer_complaint_view_list.php?a=customerComplaint&page=${page + 1}&limit=${pageLimit}&column=<?php echo $column; ?>&order=${asc_or_desc}" class="page-link">${nextLabel}</a></li>`;
        }
        liTag +=
            `<li class="page-item m-1"><a href="/customer_complaint_view_list.php?a=customerComplaint&page=${totalPages}&limit=${pageLimit}&column=<?php echo $column; ?>&order=${asc_or_desc}" class="page-link">${lastPage}</a></li>`;
    ...
    $('.print-pdf').on('click', function() {
        ...
        $.get(`/includes/customer_complaint_pdf.php?id=${id}`, function(data) {
            let opt = {
