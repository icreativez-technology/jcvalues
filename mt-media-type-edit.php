...
$_SESSION['Page_Title'] = "Edit Media Type";
$sqlData = "SELECT title FROM mt_media_type WHERE id LIKE '$_REQUEST[id]'";
                    ...
                    <div>
                        <div>
                            <p>
                                ...
                                <a href="/mt-media-type.php">Media Type</a> »
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    <div class="container-custom" id="kt_content_container">
                        <div class="card card-custom gutter-b example example-compact">
                            ...
                            <form action="includes/mt-media-type-update.php" method="post"
                                ...
                                <div class="row mt-3 ms-6 mb-6">
                                    ...
                                    <div class="col-md-2 d-flex pt-6">
                                        ...
                                        <a href="/mt-media-type.php" class="btn btn-sm btn-danger mt-3 ms-2">Cancel</a>
                                    </div>
                                </div>
                            </form>
                        </div>
