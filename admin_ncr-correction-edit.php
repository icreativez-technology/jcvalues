...
$_SESSION['Page_Title'] = "Edit NCR Correction";
                    ...
                    <div>
                        ...
                        <div>
                            <p><a href="/">Home</a> » <a href="/admin-panel.php">Admin Panel</a> » <a
                                    ...
                                    href="/admin_ncr-correction.php">NCR Correction</a> »
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    ...
                    <div class="container-custom" id="kt_content_container">
                        ...
                        <div class="card card-custom gutter-b example example-compact">
                            ...
                            <!--begin::Form-->
                            <form class="form" action="includes/basicsettings_ncr-correction_update.php" method="post"
                                enctype="multipart/form-data">
                                <input type="hidden" name="pg_id" id="pg_id"
                                    value="<?php echo $result_data['Id_ncr_correction']; ?>" readonly>
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-12">
                                            ...
                                            <small class="text-danger">The NCR corrcetion name has already been
                                                taken</small>
                                            <?php } ?>
                                        </div>
                                        <!--<div class="col-lg-6">
