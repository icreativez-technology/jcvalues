...
$_SESSION['Page_Title'] = "Edit Penetrant Type";
$sqlData = "SELECT title FROM pt_penetrant_type WHERE id LIKE '$_REQUEST[id]'";
                    ...
                    <div>
                        <div>
                            <p>
                                ...
                                <a href="/pt-penetrant-type.php">Penetrant Type</a> »
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    <div class="container-custom" id="kt_content_container">
                        <div class="card card-custom gutter-b example example-compact">
                            ...
                            <form action="includes/pt-penetrant-type-update.php" method="post"
