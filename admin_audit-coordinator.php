...
$_SESSION['Page_Title'] = "Audit Coordinator";
...
<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed aside-fixed aside-secondary-disabled">
        ...
        <div class="page d-flex flex-row flex-column-fluid">
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                ...
                <div class="row breadcrumbs">
                    <div class="col-lg-6">
                        <p><a href="/">Home</a> » <a class="cursor-pointer" data-bs-toggle="modal" data-bs-target="#admin-menu-modal">Admin Panel</a> » <a class="cursor-pointer" data-bs-toggle="modal" data-bs-target="#admin-menu-modal">Audits</a> »
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    ...
                    <div class="container-custom" id="kt_content_container">
                        ...
                        <div class="card">
                            ...
                            <!--Add form-->
                            <form action="includes/basicsettings_audit-coordinator_add.php" method="post" enctype="multipart/form-data">
                                <div class="row mt-6 ms-2">
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            <label>Coordinator</label>
                                            <select class="form-select mt-3" name="coordinator" data-control="select2" data-placeholder="Select an option" required>
                                                <option>Select an option</option>
                                                <?php
                                                $consulta = "SELECT * FROM Basic_Employee WHERE NOT EXISTS (SELECT audit_co_ordinator.Id_employee FROM audit_co_ordinator WHERE Basic_Employee.Id_employee = audit_co_ordinator.Id_Employee)";
                            ...
                            <div class="mb-3 pt-5 ps-5">
                                <div class="row">
                                    ...
                                    <div class=" col-md-6 d-flex align-items-center position-relative my-1">
                                        ...
                                        <!--end::Svg Icon-->
                                        <input type="text" data-kt-filemanager-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Search Usage Condition" id="termino" name="termino" />
                                    </div>
                                    <!--end::Search-->
                            ...
                            <div class="card-body pt-0 table-responsive">
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5 gx-5" id="kt_department_table">
                                    ...
                                    <tbody class="fw-bold text-gray-600">
                                        <?php
                                        $sql_data = "SELECT * FROM audit_co_ordinator WHERE deleted_at IS NULL order by Id_audit_co_ordinator DESC";
                                        ...
                                        ?>
                                            <tr>
                                                <td>
                                                    <?php
                                                    $consulta = "SELECT First_Name, Last_Name FROM Basic_Employee WHERE Id_employee = '$result_data[Id_Employee]'";
                                                    $consulta_general = mysqli_query($con, $consulta);
                                                    $employee_data = mysqli_fetch_assoc($consulta_general);
                                                ...
                                                <?php if ($result_data['status'] == 1) { ?>
                                                    <td><a href="/includes/basicsettings_audit-coordinator_status.php?pg_id=<?php echo $result_data['Id_audit_co_ordinator']; ?>">
                                                ...
                                                <td>
                                                    <a href="/admin_audit-coordinator-edit.php?id=<?php echo $result_data['Id_audit_co_ordinator']; ?>" class="me-2"><i class="bi bi-pencil"></i></a>
                                                    <?php if ($role == 1) { ?>
                                                        <a href="/includes/basicsettings_audit-coordinator_delete.php?id=<?php echo $result_data['Id_audit_co_ordinator']; ?>"><i class="bi bi-trash"></i></a>
                                                    <?php } ?>
                                                </td>
                                            </tr>
                                        <?php
    ...
    <script src="JS/buscar-audit-coordinator.js"></script>
    ...
    <script>
        ...
        function createPagination(totalPages, page) {
            ...
            let lastPage = ">>";
            liTag +=
                `<li class="page-item m-1"><a href="/admin_audit-coordinator.php?page=${1}&limit=${pageLimit}" class="page-link">${firstPage}</a></li>`;
            if (page > 1) {
                liTag +=
                    `<li class="page-item m-1"><a href="/admin_audit-coordinator.php?page=${page - 1}&limit=${pageLimit}" class="page-link">${prevLabel}</a></li>`;
            }
            if (page == totalPages) {
            ...
            for (var plength = beforePage; plength <= afterPage; plength++) {
                ...
                liTag +=
                    `<li class="page-item m-1 ${active}"><a href="/admin_audit-coordinator.php?page=${plength}&limit=${pageLimit}" class="page-link">${plength}</a></li>`;
            }
            if (page < totalPages) {
                liTag +=
                    `<li class="page-item m-1"><a href="/admin_audit-coordinator.php?page=${page + 1}&limit=${pageLimit}" class="page-link">${nextLabel}</a></li>`;
            }
            liTag +=
                `<li class="page-item m-1"><a href="/admin_audit-coordinator.php?page=${totalPages}&limit=${pageLimit}" class="page-link">${lastPage}</a></li>`;
