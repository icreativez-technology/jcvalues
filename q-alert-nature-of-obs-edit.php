...
$sqlData = "SELECT title FROM q_alert_nature_of_obs WHERE id LIKE '$_REQUEST[id]'";
                    ...
                    <div>
                        ...
                        <div>
                            <p><a href="/">Home</a> » <a class="cursor-pointer" data-bs-toggle="modal"
                                    ...
                                    href="/q-alert-nature-of-obs.php">Nature Of Observation</a> »
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    ...
                    <div class="container-custom" id="kt_content_container">
                        ...
                        <div class="card card-custom gutter-b example example-compact">
                            ...
                            <!--begin::Form-->
                            <form action="includes/q-alert-nature-of-obs-update.php" method="post"
                                ...
                                <div class="row mt-3 ms-6 mb-6">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <a href="/q-alert-nature-of-obs.php"
