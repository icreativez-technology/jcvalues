...
$_SESSION['Page_Title'] = "Edit Magnetizatio Direction";
$sqlData = "SELECT title FROM mt_magnetization_direction WHERE id LIKE '$_REQUEST[id]'";
                ...
                <div class="breadcrumbs">
                    <div>
                        <div>
                            <p>
                                <a href="/">Home</a> »
                                <aclass="cursor-pointer" data-bs-toggle="modal" data-bs-target="#admin-menu-modal">Admin
                                    Panel</a> »
                                    <a class="cursor-pointer" data-bs-toggle="modal"
                                        data-bs-target="#admin-menu-modal">Non-Destructive Examination</a> »
                                    <a class="cursor-pointer" data-bs-toggle="modal"
                                        data-bs-target="#admin-menu-modal">Magnetic Test</a> »
                                    <a href="/mt-magnetization-direction.php">Magnetization Direction</a> »
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    <div class="container-custom" id="kt_content_container">
                        <div class="card card-custom gutter-b example example-compact">
                            ...
                            <form action="includes/mt-magnetization-direction-update.php" method="post"
                                ...
                                <div class="row mt-3 ms-6 mb-6">
                                    ...
                                    <div class="col-md-2 d-flex pt-6">
                                        ...
                                        <a href="/mt-magnetization-direction.php"
