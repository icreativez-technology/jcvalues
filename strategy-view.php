...
$_SESSION['Page_Title'] = "View Strategy - " . $resultData['year'];
?>
<!DOCTYPE html>
<html lang="en">
                        ...
                        <div class="card card-flush">
                                            ...
                                            <tbody class="text-gray-600 fw-bold" id="list-table">
                                                ...
                                                <tr>
                                                    <td><input type="text" class="form-control"
                                                            value="<?php echo $list['strategy']; ?>" disabled></td>
                                                    <td><input type="text" class="form-control"
                                                            value="<?php echo $list['type']; ?>" disabled></td>
                                                    <td><input type="text" class="form-control"
                            ...
                            <div class="card-footer">
                                <div class="row" style="text-align:center; float:right;">
                                    <div class="mb-4">
                                        <a type="button" href="/strategy.php"
