...
$_SESSION['Page_Title'] = "Edit Testing Standard";
$sqlData = "SELECT testing_standard FROM testing_standards WHERE id LIKE '$_REQUEST[id]'";
                    ...
                    <div>
                        ...
                        <div>
                            <p><a href="/">Home</a> » <a class="cursor-pointer" data-bs-toggle="modal"
                                ...
                                <a href="/testing-standard.php">Testing Standard</a> »
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    ...
                    <div class="container-custom" id="kt_content_container">
                        ...
                        <div class="card card-custom gutter-b example example-compact">
                            ...
                            <!--begin::Form-->
                            <form action="includes/testing-standard-update.php" method="post"
                                ...
                                <div class="row mt-3 ms-6 mb-6">
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="testing_standard"
                                                value="<?php echo $resultData['testing_standard']; ?>" required>
