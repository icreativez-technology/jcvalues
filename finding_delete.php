...
$_SESSION['Page_Title'] = "Delete Finding";
/*$documetancion = scandir('/var/www/vhosts/nivelz.biz/dqms.nivelz.biz/documentacion');
 ...
 $sql_data = "SELECT * From Audit_Management_Findings WHERE Id_Audit_Management_Findings = $_REQUEST[audit_f_id]";
					...
					<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
						...
						<div class="container-custom" id="kt_content_container">
                         ...
                         <div class="card card-custom gutter-b example example-compact">
											...
											<!--begin::Form-->
											<form class="form" action="includes/finding_delete.php"  method="post" enctype="multipart/form-data">
												<input type="hidden" name="audit_f_id" id="audit_f_id" value="<?php echo $result_data['Id_Audit_Management_Findings']; ?>" readonly>
												<div class="card-body">
