		...
		<div class="page d-flex flex-row flex-column-fluid">
			...
			<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
				...
				<div class="row breadcrumbs">
					...
					<div>
						<div>
							<p><a href="/">Home</a> » <a href="/ncr.php">NCR</a> » <a href="/ncr_view_list.php">NCR List</a> »
									...
									<form class="form" action="" method="post" enctype="multipart/form-data">
				                      ...
				                      <input type="date" class="form-control" name="date"
				                        id="date" value="<?php echo date('Y-m-d'); ?>" required <?php echo $disabled ? "disabled" : ""  ?> />
												...
												<div class="form-group row">
													<div class="col-lg-6 mt-5">
														<label class="required">Similar NCR in other process/products (Mention Yes/No)</label>
														<input type="number" class="form-control" name="" id="" value="" <?php echo $disabled ? "disabled" : ""  ?> />
													</div>
													<div class="col-lg-6 mt-5">
									...
									<form class="form" action="" method="post" enctype="multipart/form-data">
										<div class="card-body">
											...
											<div class="form-group row">
												...
												<div class="col-lg-4 mt-5">
													<label class="required">Recommend to Design Head intervention</label>
													<select class="form-control" id="" name="" required <?php echo $disabled ? "disabled" : ""  ?>>
														<option value="">Yes</option>
														<option value="">No</option>
													</select>
