...
$_SESSION['Page_Title'] = "Inspection Coordinator";
...
<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed aside-fixed aside-secondary-disabled">
				...
				<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
					...
					<div class="container-custom" id="kt_content_container">
						...
						<div class="card">
							...
							<!--Add form-->
							<form action="includes/basicsettings_cm-coordinators_add.php" method="post" enctype="multipart/form-data">
							...
							<div class="card-body py-4">
								...
								<table class="table align-middle table-row-dashed fs-6 gy-5 gx-5" id="kt_table_users">
									...
									$sql_data = "SELECT * FROM Customer_Inspection_Co_Ordinator";
									$connect_data = mysqli_query($con, $sql_data);
									...
									?>
										...
										<tbody class="text-gray-600 fw-bold">
											...
											<tr>
												...
												<!--begin::Status=-->
												<?php if ($result_coordinator['Status'] == 'Active') { ?>
													<td><a href="/includes/basicsettings_cm-coordinators_status.php?pg_id=<?php echo $result_coordinator['Id_customer_inspection_co_ordinator']; ?>">
												...
												<?php if ($role == 1) { ?>
													<td class="text-end">
														<a href="/admin_cm-coordinators-delete.php?pg_id=<?php echo $result_coordinator['Id_customer_inspection_co_ordinator']; ?>"><i class="bi bi-trash" style="padding-right: 4px;"></i></a>
													</td>
												<?php } ?>
												<!--end::Action=-->
	...
	<script src="JS/buscar-cm-coordinators.js"></script>
	...
	<script>
		...
		function createPagination(totalPages, page) {
			...
			let lastPage = ">>";
			liTag +=
				`<li class="page-item m-1"><a href="/admin_cm-coordinators.php?page=${1}" class="page-link">${firstPage}</a></li>`;
			if (page > 1) {
				liTag +=
					`<li class="page-item m-1"><a href="/admin_cm-coordinators.php?page=${page - 1}" class="page-link">${prevLabel}</a></li>`;
			}
			if (page == totalPages) {
			...
			for (var plength = beforePage; plength <= afterPage; plength++) {
				...
				liTag +=
					`<li class="page-item m-1 ${active}"><a href="/admin_cm-coordinators.php?page=${plength}" class="page-link">${plength}</a></li>`;
			}
			if (page < totalPages) {
				liTag +=
					`<li class="page-item m-1"><a href="/admin_cm-coordinators.php?page=${page + 1}" class="page-link">${nextLabel}</a></li>`;
			}
			liTag +=
				`<li class="page-item m-1"><a href="/admin_cm-coordinators.php?page=${totalPages}" class="page-link">${lastPage}</a></li>`;
