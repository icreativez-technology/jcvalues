...
$_SESSION['Page_Title'] = "Edit Lighting Type";
$sqlData = "SELECT title FROM vt_lighting_type WHERE id LIKE '$_REQUEST[id]'";
                    ...
                    <div>
                        <div>
                            <p>
                                ...
                                <a href="/vt-lighting-type.php">Lighting Type</a> »
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    <div class="container-custom" id="kt_content_container">
                        <div class="card card-custom gutter-b example example-compact">
                            ...
                            <form action="includes/vt-lighting-type-update.php" method="post"
