...
$_SESSION['Page_Title'] = "Edit Type";
$sqlData = "SELECT title FROM kaizen_type WHERE id LIKE '$_REQUEST[id]'";
                    ...
                    <div>
                        ...
                        <div>
                            <p><a href="/">Home</a> » <a class="cursor-pointer" data-bs-toggle="modal"
                                    ...
                                    data-bs-toggle="modal" data-bs-target="#admin-menu-modal">Kaizen</a> » <a
                                    href="/kaizen-type.php">Kaizen Type
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    ...
                    <div class="container-custom" id="kt_content_container">
                        ...
                        <div class="card card-custom gutter-b example example-compact">
                            ...
                            <!--begin::Form-->
                            <form action="includes/kaizen-type-update.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row mt-3 ms-6 mb-6">
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <a href="/kaizen-type.php" class="btn btn-sm btn-danger mt-3 ms-2">Cancel</a>
                                    </div>
                                </div>
                            </form>
                            <!--end::Form-->
