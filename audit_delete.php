...
$_SESSION['Page_Title'] = "Delete Audit";
/*$documetancion = scandir('/var/www/vhosts/nivelz.biz/dqms.nivelz.biz/documentacion');
 ...
 $sql_data = "SELECT * From Audit_Management WHERE Id_audit_management = $_REQUEST[audit_id]";
					...
					<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
						...
						<div class="container-custom" id="kt_content_container">
                         ...
                         <div class="card card-custom gutter-b example example-compact">
											...
											<!--begin::Form-->
											<form class="form" action="includes/audit_delete.php"  method="post" enctype="multipart/form-data">
												<input type="hidden" name="audit_id" id="audit_id" value="<?php echo $result_data['Id_audit_management']; ?>" readonly>
												<div class="card-body">
