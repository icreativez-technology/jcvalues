...
$_SESSION['Page_Title'] = "Edit Effectiveness verification";
 ...
 $sql_data = "SELECT * FROM NCR_MR_Approval WHERE Id_ncr_mr_approval = '$_REQUEST[pg_id]'";
				...
				<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
					...
					<div class="row breadcrumbs">
						...
						<div>
							<!--begin::Title-->
							<div>
								<p><a href="/">Home</a> » <a href="/ncr.php">NCR</a> » <a href="/ncr_view_list.php">NCR List</a> » <a href="/ncr_view.php?pg_id=<?php echo $_REQUEST['pg_id']; ?>">View NCR</a> » <a href="/ncr_mr_approval.php?pg_id=<?php echo $_REQUEST['return_id']; ?>">NCR MR Approval</a> » <?php echo $_SESSION['Page_Title']; ?></p>
								<!-- MIGAS DE PAN -->
							</div>
						</div>
						<!--end::body-->
					...
					<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
						...
						<div class="container-custom" id="kt_content_container">
                         ...
                         <!-- AQUI AÑADIR EL CONTENIDO  -->
                         	...
                         	<form class="form" action="includes/ncr_mr_approval_update_individual.php" method="post" enctype="multipart/form-data">
                         		<input type="hidden" name="pg_id" id="pg_id" value="<?php echo $result_data['Id_ncr_mr_approval']; ?>" readonly>
							 ...
							 <div class="card-body">
									 <div id="custom-section-1">
									  ...
									  <div class="form-group row">
									   ...
									   <div class="col-lg-4">
									    <label>MR Approval</label>
											<input type="text" class="form-control" name="MR_Approval" value="<?php echo $result_data['MR_Approval'];?>" required>
									   </div>
