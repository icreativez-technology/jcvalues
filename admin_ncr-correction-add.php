...
$_SESSION['Page_Title'] = "Add NCR Correction";
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    ...
                    <div class="container-custom" id="kt_content_container">
                        ...
                        <div class="card card-custom gutter-b example example-compact">
                            ...
                            <!--begin::Form-->
                            <form class="form" action="includes/basicsettings_ncr-correction_add.php" method="post"
                                ...
                                <div class="card-body">
                                    <div class="form-group row">
                                        <div class="col-lg-12">
                                            ...
                                            <small class="text-danger">The NCR Correction name has already been
                                                taken</small>
                                            <?php } ?>
                                        </div>
                                    </div>
