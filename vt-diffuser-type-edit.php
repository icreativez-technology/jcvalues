...
$_SESSION['Page_Title'] = "Edit Diffuser Type";
$sqlData = "SELECT title FROM vt_diffuser_type WHERE id LIKE '$_REQUEST[id]'";
                    ...
                    <div>
                        <div>
                            <p>
                                ...
                                <a href="/vt-diffuser-type.php">Diffuser Type</a> »
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    <div class="container-custom" id="kt_content_container">
                        <div class="card card-custom gutter-b example example-compact">
                            ...
                            <form action="includes/vt-diffuser-type-update.php" method="post"
