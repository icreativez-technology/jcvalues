...
$sqlData = "SELECT title FROM category WHERE id LIKE '$_REQUEST[id]'";
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                ...
                <div class="breadcrumbs">
                    ...
                    <div>
                        <!--begin::Title-->
                        <div>
                            <p><a href="/">Home</a> » <a href="/admin-panel.php">Admin Panel</a> » <a href="/kaizen.php">Kaizen</a> » <a href="/category.php">Category</a> » <?php echo $_SESSION['Page_Title']; ?></p>
                        </div>
                    </div>
                    <!--end::body-->
                </div>
                            ...
                            <form action="includes/category-update.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row mt-3 ms-6 mb-6">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <a href="/category.php" class="btn btn-sm btn-danger mt-3 ms-2">Cancel</a>
                                    </div>
                                </div>
                            </form>
                            <!--end::Form-->
