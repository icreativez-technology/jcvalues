...
$_SESSION['Page_Title'] = "Compliants";
?>
...
<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed aside-fixed aside-secondary-disabled">
    ...
    <div class="d-flex flex-column flex-root">
            ...
            <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content" style="padding: 0;">
                    ...
                    <div class="container-custom" id="kt_content_container">
                        ...
                        ?>
                                                <option value="<?php echo $result_data_pg['Id_product_group']; ?>"
                                                    selected="selected"><?php echo $result_data_pg['Title']; ?></option>
                                                <?php
                            } else {
                            ?>
                                                <option value="<?php echo $result_data_pg['Id_product_group']; ?>">
                                                    <?php echo $result_data_pg['Title']; ?></option>
                                                <?php
                            }
                          }
                        }
                        ...
                        ?>
                                                <option value="<?php echo $result_data_dep['Id_department']; ?>"
                                                    selected="selected"><?php echo $result_data_dep['Department']; ?>
                                                </option>
                                                <?php
                            } else {
                            ?>
                        ...
                        ?>
                            ...
                            <div class="row mt-4">
                                <div class="col-lg-6 mt-2">
                                    <div class="card">
                                        <div class="card-header pb-2 pt-4">
                                            <h4>Nature Of Compliants</h4>
                                        </div>
                                        <div class="card-body">
                                            <canvas id="nature-compliants"></canvas>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6 mt-2">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <canvas id="action-category-chart"></canvas>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        const anginData = {
            ...
            datasets: [{
                    label: '0-15',
                    backgroundColor: 'rgb(3, 208, 200)',
                    borderColor: 'rgb(3, 208, 200)',
                    data: getRandomVal(11),
                },
                {
                    label: 'Above 15',
                    backgroundColor: 'rgb(226, 55, 111)',
                    borderColor: 'rgb(226, 55, 111)',
                    data: getRandomVal(11),
                }
            ]
        };
        ...
        //Nature of Compliants chart
        const natureObservationLabels = [
            'item1',
            'item2',
            'item3',
            'item4',
        ...
        const natureObservationData = {
            labels: natureObservationLabels,
            datasets: [{
                    label: 'Open',
                    backgroundColor: 'rgb(254, 215, 19)',
                    borderColor: 'rgb(254, 215, 19)',
        ...
        const natureObservationChart = new Chart(
            document.getElementById('nature-compliants'), {
                type: 'bar',
                data: natureObservationData,
                options: {
                    scales: {
                        x: {
                            grid: {
        ...
        const processChart = new Chart(
            document.getElementById('action-category-chart'), {
                type: 'bar',
                data: processData,
                options: {
                    scales: {
