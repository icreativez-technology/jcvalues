...
$_SESSION['Page_Title'] = "Edit Technique";
$sqlData = "SELECT title FROM vt_technique WHERE id LIKE '$_REQUEST[id]'";
                    ...
                    <div>
                        <div>
                            <p>
                                ...
                                <a class="cursor-pointer" data-bs-toggle="modal" data-bs-target="#admin-menu-modal">
                                    Visual Test</a> » <a href="/vt-technique.php">Technique</a> »
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    <div class="container-custom" id="kt_content_container">
                        <div class="card card-custom gutter-b example example-compact">
                            ...
                            <form action="includes/vt-technique-update.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row mt-3 ms-6 mb-6">
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <small class="text-danger">The technique name has already been
                                                taken</small>
                                            <?php } ?>
                                        </div>
                                    </div>
                                    <div class="col-md-2 d-flex pt-6">
                                        ...
                                        <a href="/vt-technique.php" class="btn btn-sm btn-danger mt-3 ms-2">Cancel</a>
                                    </div>
                                </div>
                            </form>
                        </div>
