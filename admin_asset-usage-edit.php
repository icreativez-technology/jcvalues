                    ...
                    <div>
                        ...
                        <div>
                            <p><a href="/">Home</a> » <a href="/admin-panel.php">Admin Panel</a> » <a
                                    ...
                                    href="/admin_asset-usage.php">Usage Condition Management</a> »
                ...
                <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                    ...
                    <div class="container-custom" id="kt_content_container">
                        ...
                        <div class="card card-custom gutter-b example example-compact">
                            ...
                            <!--begin::Form-->
                            <form class="form" action="includes/basicsettings_asset-usage_update.php" method="post"
                                enctype="multipart/form-data">
                                <input type="hidden" name="pg_id" id="pg_id"
                                    value="<?php echo $result_data['Id_asset_usage_condition']; ?>" readonly>
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-12">
                                            ...
                                            <small class="text-danger">The usage condition name has already been
                                                taken</small>
                                            <?php } ?>
                                        </div>
                                        <!--<div class="col-lg-6">
                                ...
                                <div class="p-4">
                                    <div class="row">
                                        <div style="text-align: right;"><input type="submit"
                                                ...
                                                href="/admin_asset-usage.php" class="btn btn-sm btn-danger">Cancel</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
