...
$_SESSION['Page_Title'] = "NCR Disposition";
...
<body id="kt_body" class="header-fixed header-tablet-and-mobile-fixed aside-fixed aside-secondary-disabled">
				...
				<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
					...
					<div class="container-custom" id="kt_content_container">
						...
						<div class="card">
							...
							<!--Add form-->
							<form action="includes/basicsettings_ncr-disposition_add.php" method="post" enctype="multipart/form-data">
								<div class="row mt-6 ms-2">
									<div class="col-md-5">
										<div class="form-group">
											<label>NCR disposition</label>
											<input type="text" class="form-control" name="title" required>
											<?php if (isset($_GET['exist'])) { ?>
												<small class="text-danger">The NCR disposition name has already been taken</small>
											<?php } ?>
										</div>
									</div>
									<div class="col-md-2">
							...
							<div class="pt-6  ms-5 mb-5">
								...
								<div class="row">
									...
									<div class="col-md-6 d-flex align-items-center position-relative my-1">
										...
										<!--end::Svg Icon-->
										<input type="text" data-kt-filemanager-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Search NCR Disposition" id="termino" name="termino" />
									</div>
									<!--end::Search-->
								</div>
								<!--begin::Card title-->
										...
										?>
											<tr>
												...
												<?php if ($result_data['Status'] == 'Active') { ?>
													<td><a href="/includes/basicsettings_ncr-disposition_status.php?pg_id=<?php echo $result_data['Id_ncr_disposition']; ?>">
												...
												<!--begin::Action=-->
												<td class="text-end">
													<a href="/admin_ncr-disposition-edit.php?pg_id=<?php echo $result_data['Id_ncr_disposition']; ?>"><i class="bi bi-pencil" style="padding-right: 4px;"></i></a>
													<?php if ($role == 1) { ?>
														<a href="/admin_ncr-disposition-delete.php?pg_id=<?php echo $result_data['Id_ncr_disposition']; ?>"><i class="bi bi-trash" style="padding-right: 4px;"></i></a>
													<?php } ?>
												</td>
												<!--end::Action=-->
											</tr>
	...
	<!-- BUSCADOR SEARCH PARA: NCR Disp -->
	<script src="JS/buscar-ncr-disposition.js"></script>
	...
	<script>
		...
		function createPagination(totalPages, page) {
			...
			let lastPage = ">>";
			liTag +=
				`<li class="page-item m-1"><a href="/admin_ncr-disposition.php
?page=${1}" class="page-link">${firstPage}</a></li>`;
			if (page > 1) {
				liTag +=
					`<li class="page-item m-1"><a href="/admin_ncr-disposition.php
?page=${page - 1}" class="page-link">${prevLabel}</a></li>`;
			}
			if (page == totalPages) {
			...
			for (var plength = beforePage; plength <= afterPage; plength++) {
				...
				liTag +=
					`<li class="page-item m-1 ${active}"><a href="/admin_ncr-disposition.php
?page=${plength}" class="page-link">${plength}</a></li>`;
			}
			if (page < totalPages) {
				liTag +=
					`<li class="page-item m-1"><a href="/admin_ncr-disposition.php
?page=${page + 1}" class="page-link">${nextLabel}</a></li>`;
			}
			liTag +=
				`<li class="page-item m-1"><a href="/admin_ncr-disposition.php
?page=${totalPages}" class="page-link">${lastPage}</a></li>`;
